...
IF (KOKKOS_ENABLE_PTHREAD)
  ...
  LIST(APPEND KOKKOS_COMPILE_OPTIONS -pthread)
  LIST(APPEND KOKKOS_LINK_OPTIONS -pthread)
  GLOBAL_SET(KOKKOS_COMPILE_OPTIONS ${KOKKOS_COMPILE_OPTIONS})
  GLOBAL_SET(KOKKOS_LINK_OPTIONS ${KOKKOS_LINK_OPTIONS})
ENDIF()
