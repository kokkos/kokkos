...
set(addpathl)
message("prior to foreach statement")
foreach(kvar IN LISTS KOKKOS_USE_TPLS_LIST ITEMS CUDA QTHREADS)
  message("checking KOKKOS_ENABLE_${kvar}=${KOKKOS_ENABLE_${kvar}}")
  if(${KOKKOS_ENABLE_${kvar}})
    message("processing KOKKOS_${kvar}_DIR, KOKKOS_INTERNAL_PATHS=${KOKKOS_INTERNAL_PATHS}")
...
message("before adding to KOKKOS_SETTINGS, KOKKOS_INTERNAL_PATHS=${KOKKOS_INTERNAL_PATHS}")
