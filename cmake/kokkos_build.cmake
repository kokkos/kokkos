...
IF(KOKKOS_SEPARATE_LIBS)
  ...
  foreach(lib IN LISTS KOKKOS_TPL_LIBRARY_NAMES)
    ...
    elseif ("${lib}" STREQUAL "hpx")
      ...
      if(${HPX_FOUND})
        target_link_libraries(kokkoscore PRIVATE ${HPX_LIBRARIES})
        target_link_libraries(kokkoscontainers PRIVATE ${HPX_LIBRARIES})
        target_include_directories(kokkoscore PRIVATE ${HPX_INCLUDE_DIRS})
        target_include_directories(kokkoscore PRIVATE ${HPX_INCLUDE_DIRS})
      else()
...
ELSE()
  ...
  foreach(lib IN LISTS KOKKOS_TPL_LIBRARY_NAMES)
    ...
    elseif ("${lib}" STREQUAL "hpx")
      find_package(HPX REQUIRED)
      if(${HPX_FOUND})
        target_link_libraries(kokkos PRIVATE ${HPX_LIBRARIES})
        target_include_directories(kokkos PRIVATE ${HPX_INCLUDE_DIRS})
      else()
        message(ERROR "HPX not found. Check the value of HPX_DIR (= ${HPX_DIR}) or CMAKE_PREFIX_PATH (= ${CMAKE_PREFIX_PATH}).")
      endif()
    else()
