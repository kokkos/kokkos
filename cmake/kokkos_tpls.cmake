...
CMAKE_DEPENDENT_OPTION(Kokkos_ENABLE_ROCTHRUST "Enable rocThrust support" ON "Kokkos_ENABLE_HIP" OFF)
IF(KOKKOS_ENABLE_HIP AND Kokkos_ENABLE_ROCTHRUST)
  SET(ROCTHRUST_DEFAULT ON)
  MESSAGE(STATUS "ROCTHRUST_DEFAULT ON")
ELSE()
  SET(ROCTHRUST_DEFAULT OFF)
  MESSAGE(STATUS "ROCTHRUST_DEFAULT OFF")
ENDIF()
...
IF (NOT KOKKOS_ENABLE_COMPILE_AS_CMAKE_LANGUAGE)
  ...
  KOKKOS_IMPORT_TPL(ROCTHRUST INTERFACE)
ENDIF()
