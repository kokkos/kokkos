...
MACRO(KOKKOS_CONFIGURE_CORE)
   ...
   ENDFOREACH()
   FOREACH(MEMSPACE ${KOKKOS_ALL_MEMSPACE_LIST})
	   LIST(APPEND FWD_ALL_BACKEND_LIST ${MEMSPACE})
   ENDFOREACH()
   FOREACH(BACKEND_ ${KOKKOS_ENABLED_DEVICES})
      ...
      ENDIF()
   ENDFOREACH()
   FOREACH(BACKEND_ ${KOKKOS_ALL_DEVICES})
      IF( ${BACKEND_} STREQUAL "PTHREAD")
         LIST(APPEND FWD_ALL_BACKEND_LIST THREADS)
      ELSE()
         LIST(APPEND FWD_ALL_BACKEND_LIST ${BACKEND_})
      ENDIF()
   ENDFOREACH()
   MESSAGE(STATUS "Kokkos Devices: ${KOKKOS_ENABLED_DEVICES}, Kokkos Backends: ${FWD_BACKEND_LIST}")
   KOKKOS_CONFIG_HEADER( KokkosCore_Config_HeaderSet.in KokkosCore_Config_FwdBackend.hpp "KOKKOS_FWD" "fwd/Kokkos_Fwd" "${FWD_ALL_BACKEND_LIST}")
