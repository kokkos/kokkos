...
MACRO(KOKKOS_INSTALL_ADDITIONAL_FILES)
   ...
   INSTALL(FILES "${PROJECT_BINARY_DIR}/Kokkos_Set_Default_Spaces.hpp" DESTINATION ${CMAKE_INSTALL_INCLUDEDIR})
   ...
   FOREACH(PLUGIN_ ${KOKKOS_INSTALL_PLUGIN_LIST})
      INSTALL(FILES "${PROJECT_BINARY_DIR}/${PLUGIN_}" DESTINATION ${CMAKE_INSTALL_INCLUDEDIR})
   ENDFOREACH()
ENDMACRO()
