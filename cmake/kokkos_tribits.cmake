...
FUNCTION(KOKKOS_SET_LIBRARY_PROPERTIES LIBRARY_NAME)
  ...
  SET(FLAG_VISIBILITY PUBLIC)
  IF(PARSE_PRIVATE)
    SET(FLAG_VISIBILITY PRIVATE)
  ENDIF()
  ...
  ELSE()
    IF (PARSE_PLAIN_STYLE)
      TARGET_LINK_LIBRARIES(
        ${LIBRARY_NAME} ${FLAG_VISIBILITY} ${KOKKOS_LINK_OPTIONS}
      )
    ELSE()
  ...
  IF (KOKKOS_ENABLE_CUDA)
    TARGET_COMPILE_OPTIONS(
      ${LIBRARY_NAME}
      ${FLAG_VISIBILITY} $<$<COMPILE_LANGUAGE:CXX>:${KOKKOS_CUDA_OPTIONS}>
    )
    ...
    TARGET_COMPILE_OPTIONS(
      ${LIBRARY_NAME} 
      ${FLAG_VISIBILITY} $<$<COMPILE_LANGUAGE:CXX>:${NODEDUP_CUDAFE_OPTIONS}>
    )
  ENDIF()
  ...
  IF(KOKKOS_XCOMPILER_OPTIONS)
    ...
    TARGET_COMPILE_OPTIONS(
      ${LIBRARY_NAME} 
      ${FLAG_VISIBILITY} $<$<COMPILE_LANGUAGE:CXX>:${NODEDUP_XCOMPILER_OPTIONS}>
    )
  ENDIF()

  IF (KOKKOS_CXX_STANDARD_FEATURE)
    #GREAT! I can do this the right way
    TARGET_COMPILE_FEATURES(${LIBRARY_NAME} ${FLAG_VISIBILITY} ${KOKKOS_CXX_STANDARD_FEATURE})
  ...
  ELSE()
    ...
    TARGET_COMPILE_OPTIONS(${LIBRARY_NAME} ${FLAG_VISIBILITY} ${KOKKOS_CXX_STANDARD_FLAG})
  ENDIF()
ENDFUNCTION()
