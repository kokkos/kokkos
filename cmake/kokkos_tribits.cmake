...
MACRO(KOKKOS_CONFIGURE_CORE)
   ...
   ELSE()
      ...
      ENDIF()
   ENDIF()
   IF (NOT Kokkos_DEFAULT_DEVICE_MEMORY_SPACE STREQUAL "")
      SET(_DEFAULT_DEVICE_MEMSPACE ${Kokkos_DEFAULT_DEVICE_MEMORY_SPACE})
   ENDIF()
   IF (NOT Kokkos_DEFAULT_HOST_MEMORY_SPACE STREQUAL "")
      SET(_DEFAULT_HOST_MEMSPACE ${Kokkos_DEFAULT_HOST_MEMORY_SPACE})
   ENDIF()
   CONFIGURE_FILE(cmake/Kokkos_Set_Default_Spaces.hpp.in Kokkos_Set_Default_Spaces.hpp @ONLY)
...
MACRO(KOKKOS_INSTALL_ADDITIONAL_FILES)
   ...
   INSTALL(FILES "${CMAKE_BINARY_DIR}/KokkosCore_Config_FwdBackend.hpp" DESTINATION ${CMAKE_INSTALL_INCLUDEDIR})
   ...
   INSTALL(FILES "${CMAKE_BINARY_DIR}/KokkosCore_Config_PostInclude.hpp" DESTINATION ${CMAKE_INSTALL_INCLUDEDIR})
