...
FUNCTION(KOKKOS_INTERNAL_ADD_LIBRARY LIBRARY_NAME)
  ...
  IF (KOKKOS_ENABLE_CUDA)
    IF (KOKKOS_CXX_COMPILER_ID STREQUAL Clang)
       ...
       find_library( cuda_lib_ NAMES libcuda.so cuda HINTS ${KOKKOS_CUDA_DIR}/lib64 )
       find_library( cudart_lib_ NAMES libcudart.so cudart HINTS ${KOKKOS_CUDA_DIR}/lib64 )
       if (cuda_lib_)
       ...
       if (cudart_lib_)
          ...
          TARGET_LINK_LIBRARIES(${LIBRARY_NAME} PUBLIC cudart)
       endif()
    else()
       SET(LIB_cuda "-lcuda")
       TARGET_LINK_LIBRARIES(${LIBRARY_NAME} PUBLIC cuda)
