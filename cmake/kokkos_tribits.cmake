...
MACRO(KOKKOS_MAKE_LIBKOKKOS)
  ...
  ELSE()
    ...
    TARGET_LINK_LIBRARIES(kokkos PUBLIC kokkosalgorithms)
    IF(${CMAKE_VERSION} VERSION_LESS "3.13" OR MSVC)
      STRING (REPLACE ";" " " KOKKOS_LINK_OPTIONS_STR "${KOKKOS_LINK_OPTIONS}")
      MESSAGE(STATUS "updating link flags property with ${KOKKOS_LINK_OPTIONS_STR}")
      SET_TARGET_PROPERTIES(kokkos PROPERTIES LINK_FLAGS ${KOKKOS_LINK_OPTIONS_STR})
    ELSE()
      MESSAGE(STATUS "updating target link options with ${KOKKOS_LINK_OPTIONS}")
      TARGET_LINK_OPTIONS(kokkos PUBLIC ${KOKKOS_LINK_OPTIONS})
    ENDIF()
  ENDIF()
