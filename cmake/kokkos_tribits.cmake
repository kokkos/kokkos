...
macro(KOKKOS_INTERNAL_ADD_LIBRARY_INSTALL LIBRARY_NAME)
  ...
  message(STATUS "${LIBRARY_NAME}: ${INCTYPE}")
  ...
  install(
    ...
    FILE_SET ${LIBRARY_NAME}_file_set DESTINATION ${CMAKE_INSTALL_LIBDIR}/cmake/${PROJECT_NAME}/src
  )
...
function(KOKKOS_INTERNAL_ADD_LIBRARY LIBRARY_NAME)
	cmake_parse_arguments(PARSE "STATIC;SHARED" "" "HEADERS;SOURCES;MODULE_FILES" ${ARGN})
  ...
  endforeach()
  foreach(source ${PARSE_MODULE_FILES})
    set_source_files_properties(${source} PROPERTIES LANGUAGE ${KOKKOS_COMPILE_LANGUAGE})
  endforeach()
  ...
  if (PARSE_MODULE_FILES)
   target_sources(
	   ${LIBRARY_NAME}
     PUBLIC
     FILE_SET ${LIBRARY_NAME}_file_set TYPE CXX_MODULES
     FILES ${PARSE_MODULE_FILES}
    )
  endif()
