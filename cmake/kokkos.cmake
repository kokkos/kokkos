...
if(KOKKOS_ENABLE_CUDA)
  ...
  if(KOKKOS_GPU_ARCH STREQUAL Kepler30)
    ...
    list(APPEND KOKKOS_CXX_FLAGS ${KOKKOS_COMPILER_CUDA_ARCH_FLAG}=sm_30)
    list(APPEND KOKKOS_LD_FLAGS ${KOKKOS_COMPILER_CUDA_ARCH_FLAG}=sm_30)
  elseif(KOKKOS_GPU_ARCH STREQUAL Kepler32)
    set(KOKKOS_ARCH_KEPLER ON CACHE INTERNAL "")
    set(KOKKOS_ARCH_KEPLER32 ON CACHE INTERNAL "")
    list(APPEND KOKKOS_CXX_FLAGS ${KOKKOS_COMPILER_CUDA_ARCH_FLAG}=sm_32)
    list(APPEND KOKKOS_LD_FLAGS ${KOKKOS_COMPILER_CUDA_ARCH_FLAG}=sm_32)
  elseif(KOKKOS_GPU_ARCH STREQUAL Kepler35 OR KOKKOS_GPU_ARCH STREQUAL Kepler)
    set(KOKKOS_ARCH_KEPLER ON CACHE INTERNAL "")
    set(KOKKOS_ARCH_KEPLER35 ON CACHE INTERNAL "")
    list(APPEND KOKKOS_CXX_FLAGS ${KOKKOS_COMPILER_CUDA_ARCH_FLAG}=sm_35)
    list(APPEND KOKKOS_LD_FLAGS ${KOKKOS_COMPILER_CUDA_ARCH_FLAG}=sm_35)
  elseif(KOKKOS_GPU_ARCH STREQUAL Kepler37)
    set(KOKKOS_ARCH_KEPLER ON CACHE INTERNAL "")
    set(KOKKOS_ARCH_KEPLER37 ON CACHE INTERNAL "")
    list(APPEND KOKKOS_CXX_FLAGS ${KOKKOS_COMPILER_CUDA_ARCH_FLAG}=sm_37)
    list(APPEND KOKKOS_LD_FLAGS ${KOKKOS_COMPILER_CUDA_ARCH_FLAG}=sm_37)
  elseif(KOKKOS_GPU_ARCH STREQUAL Maxwell50 OR KOKKOS_GPU_ARCH STREQUAL Maxwell)
    ...
    list(APPEND KOKKOS_CXX_FLAGS ${KOKKOS_COMPILER_CUDA_ARCH_FLAG}=sm_50)
    list(APPEND KOKKOS_LD_FLAGS ${KOKKOS_COMPILER_CUDA_ARCH_FLAG}=sm_50)
  elseif(KOKKOS_GPU_ARCH STREQUAL Maxwell52)
    set(KOKKOS_ARCH_MAXWELL ON CACHE INTERNAL "")
    set(KOKKOS_ARCH_MAXWELL52 ON CACHE INTERNAL "")
    list(APPEND KOKKOS_CXX_FLAGS ${KOKKOS_COMPILER_CUDA_ARCH_FLAG}=sm_52)
    list(APPEND KOKKOS_LD_FLAGS ${KOKKOS_COMPILER_CUDA_ARCH_FLAG}=sm_52)
  elseif(KOKKOS_GPU_ARCH STREQUAL Maxwell53)
    set(KOKKOS_ARCH_MAXWELL ON CACHE INTERNAL "")
    set(KOKKOS_ARCH_MAXWELL53 ON CACHE INTERNAL "")
    list(APPEND KOKKOS_CXX_FLAGS ${KOKKOS_COMPILER_CUDA_ARCH_FLAG}=sm_53)
    list(APPEND KOKKOS_LD_FLAGS ${KOKKOS_COMPILER_CUDA_ARCH_FLAG}=sm_53)
  elseif(KOKKOS_GPU_ARCH STREQUAL Pascal60)
    ...
    list(APPEND KOKKOS_CXX_FLAGS ${KOKKOS_COMPILER_CUDA_ARCH_FLAG}=sm_60)
    list(APPEND KOKKOS_LD_FLAGS ${KOKKOS_COMPILER_CUDA_ARCH_FLAG}=sm_60)
  elseif(KOKKOS_GPU_ARCH STREQUAL Pascal61)
    set(KOKKOS_ARCH_PASCAL ON CACHE INTERNAL "")
    set(KOKKOS_ARCH_PASCAL61 ON CACHE INTERNAL "")
    list(APPEND KOKKOS_CXX_FLAGS ${KOKKOS_COMPILER_CUDA_ARCH_FLAG}=sm_61)
    list(APPEND KOKKOS_LD_FLAGS ${KOKKOS_COMPILER_CUDA_ARCH_FLAG}=sm_61)
  endif()
endif()
