...
MACRO(TARGET_LINK_AND_INCLUDE_LIBRARIES TARGET_NAME)
  ...
  FOREACH(DEP_LIB ${ARGN})
    TARGET_INCLUDE_DIRECTORIES(${TARGET_NAME} INTERFACE $<TARGET_PROPERTY:${DEP_LIB},INTERFACE_INCLUDE_DIRECTORIES>)
    TARGET_INCLUDE_DIRECTORIES(${TARGET_NAME} INTERFACE $<TARGET_PROPERTY:${DEP_LIB},INCLUDE_DIRECTORIES>)
  ENDFOREACH()
ENDMACRO()
...
MACRO(TIBITS_CREATE_IMPORTED_TPL_LIBRARY TPL_NAME)
  ...
  TARGET_LINK_LIBRARIES(TPL_LIB_${TPL_NAME} INTERFACE ${TPL_${TPL_NAME}_LIBRARIES})
