...
GET_FILENAME_COMPONENT(KOKKOS_COMPILER_EXE ${CMAKE_CXX_COMPILER} NAME)
STRING(REGEX MATCH "nvcc" HAVE_NVCC ${KOKKOS_COMPILER_EXE})
IF (HAVE_NVCC)
  STRING(REGEX MATCH "nvcc_wrapper" HAVE_NVCC_WRAPPER ${KOKKOS_COMPILER_EXE})
  IF (NOT HAVE_NVCC_WRAPPER)
    MESSAGE(FATAL_ERROR "Using NVCC compiler directly is not supported - must use nvcc_wrapper")
  ENDIF()
  ...
  EXECUTE_PROCESS(COMMAND ${CMAKE_CXX_COMPILER} --version --device
