...
FUNCTION(KOKKOS_ADD_TEST)
  if (KOKKOS_HAS_TRILINOS)
    ...
    SET(EXE ${PACKAGE_NAME}_${EXE_ROOT})
    IF (TEST_ARGS)
      STRING(REPLACE " " ";" COMMON_ARGS_LIST "${TEST_COMMON_ARGS}")
      SET(TEST_NUMBER 0)
      FOREACH (ARG_STR ${TEST_ARGS})
        ...
        IF(WIN32)
          ADD_TEST(NAME ${TEST_NAME}${TEST_NUMBER} WORKING_DIRECTORY ${LIBRARY_OUTPUT_PATH}
                   COMMAND ${EXE}${CMAKE_EXECUTABLE_SUFFIX} ${COMMON_ARGS_LIST} ${ARG_STR_LIST})
        ELSE()
          ADD_TEST(NAME ${TEST_NAME}${TEST_NUMBER}
              COMMAND ${EXE} ${COMMON_ARGS_LIST} ${ARG_STR_LIST})
        ENDIF()
    ...
    ELSE()
      IF(WIN32)
        ADD_TEST(NAME ${TEST_NAME} WORKING_DIRECTORY ${LIBRARY_OUTPUT_PATH}
                 COMMAND ${EXE}${CMAKE_EXECUTABLE_SUFFIX} ${TEST_COMMON_ARGS})
      ELSE()
        ADD_TEST(NAME ${TEST_NAME} COMMAND ${EXE} ${TEST_COMMON_ARGS})
      ENDIF()
