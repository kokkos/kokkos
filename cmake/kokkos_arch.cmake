...
ELSE()
  ...
  GLOBAL_APPEND(KOKKOS_AMDGPU_OPTIONS -D__HIP_ROCclr__)
  ...
  ENDIF()
  #GET_FILENAME_COMPONENT(LIB_AMD_HIP_DIR ${LIB_AMD_HIP} DIRECTORY)
  #GET_FILENAME_COMPONENT(LIB_HSA_RUNTIME_DIR ${LIB_HSA_RUNTIME} DIRECTORY)
  #IF(NOT LIB_AMD_HIP_DIR STREQUAL LIB_HSA_RUNTIME_DIR)
  #  MESSAGE(FATAL_ERROR "")
  #ENDIF()
ENDIF()
