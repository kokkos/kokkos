...
SET(_HOST_PARALLEL_STRING "    Host Parallel:")
IF(KOKKOS_ENABLE_OPENMP)
  SET(_HOST_PARALLEL_STRING "${_HOST_PARALLEL_STRING} OPENMP")
ENDIF()
IF(KOKKOS_ENABLE_PTHREAD)
  SET(KOKKOS_ENABLE_THREADS ON)
  SET(_HOST_PARALLEL_STRING "${_HOST_PARALLEL_STRING} PTHREAD")
ENDIF()
IF(KOKKOS_ENABLE_QTHREADS)
  SET(_HOST_PARALLEL_STRING "${_HOST_PARALLEL_STRING} QTHREADS")
ENDIF()
IF(KOKKOS_ENABLE_HPX)
  SET(_HOST_PARALLEL_STRING "${_HOST_PARALLEL_STRING} HPX")
ENDIF()
IF (_HOST_PARALLEL_STRING STREQUAL "    Host Parallel:")
  SET(_HOST_PARALLEL_STRING "    Host Parallel: NONE")
ENDIF()
MESSAGE(STATUS "${_HOST_PARALLEL_STRING}")
