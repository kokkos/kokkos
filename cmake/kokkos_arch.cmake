...
FUNCTION(ARCH_FLAGS)
  ...
  LIST(APPEND NEW_LINK_OPTIONS ${KOKKOS_COMPILE_OPTIONS})
...
IF (KOKKOS_ARCH_KEPLER30)
  GLOBAL_APPEND(KOKKOS_CUDA_OPTIONS "${CUDA_ARCH_FLAGS}=sm_30")
ENDIF()

IF (KOKKOS_ARCH_KEPLER32)
  GLOBA_APPEND(KOKKOS_CUDA_OPTIONS "${CUDA_ARCH_FLAG}=sm_32")
ENDIF()

IF (KOKKOS_ARCH_KEPLER35)
  GLOBAL_APPEND(KOKKOS_CUDA_OPTIONS "${CUDA_ARCH_FLAG}=sm_35")
ENDIF()

IF (KOKKOS_ARCH_KEPLER35)
  GLOBAL_APPEND(KOKKOS_CUDA_OPTIONS "${CUDA_ARCH_FLAG}=sm_37")
ENDIF()

IF (KOKKOS_ARCH_MAXWELL50)
  GLOBAL_APPEND(KOKKOS_CUDA_OPTIONS "${CUDA_ARCH_FLAG}=sm_50")
ENDIF()

IF (KOKKOS_ARCH_MAXWELL52)
  GLOBAL_APPEND(KOKKOS_CUDA_OPTIONS "${CUDA_ARCH_FLAG}=sm_52")
ENDIF()

IF (KOKKOS_ARCH_MAXWELL53)
  GLOBAL_APPEND(KOKKOS_CUDA_OPTIONS "${CUDA_ARCH_FLAG}=sm_53")
ENDIF()

IF (KOKKOS_ARCH_PASCAL60)
  GLOBAL_APPEND(KOKKOS_CUDA_OPTIONS "${CUDA_ARCH_FLAG}=sm_60")
ENDIF()

IF (KOKKOS_ARCH_PASCAL61)
  GLOBAL_APPEND(KOKKOS_CUDA_OPTIONS "${CUDA_ARCH_FLAG}=sm_61")
ENDIF()

IF (KOKKOS_ARCH_VOLTA70)
  GLOBAL_APPEND(KOKKOS_CUDA_OPTIONS "${CUDA_ARCH_FLAG}=sm_70")
ENDIF()

IF (KOKKOS_ARCH_VOLTA72)
  GLOBAL_APPEND(KOKKOS_CUDA_OPTIONS "${CUDA_ARCH_FLAG}=sm_72")
ENDIF()

IF (KOKKOS_ARCH_TURING75)
  GLOBAL_APPEND(KOKKOS_CUDA_OPTIONS "${CUDA_ARCH_FLAG}=sm_75")
ENDIF()
