...
LIST(APPEND SUPPORTED_AMD_ARCHS      VEGA942  AMD_GFX942)
LIST(APPEND CORRESPONDING_AMD_FLAGS  gfx942   gfx942)
...
FOREACH(ARCH IN LISTS SUPPORTED_AMD_ARCHS)
  IF (KOKKOS_ARCH_${ARCH})
    STRING(REGEX MATCH "942" IS_942 ${ARCH})
    IF(IS_90A)
      SET(KOKKOS_ARCH_AMD_GFX942 ON)
      SET(KOKKOS_ARCH_VEGA942 ON)
      BREAK()
    ENDIF()
