...
IF (KOKKOS_CXX_COMPILER_ID STREQUAL NVIDIA)
  ...
  IF (KOKKOS_ENABLE_DEBUG OR _UPPERCASE_CMAKE_BUILD_TYPE STREQUAL "DEBUG")
    # This was only fixed for NVCC 10.0.130, see https://github.com/kokkos/kokkos/issues/1410
    IF (KOKKOS_CXX_COMPILER_VERSION VERSION_LESS 10.0)
      GLOBAL_APPEND(KOKKOS_CUDA_OPTIONS -lineinfo)
    ELSE()
      GLOBAL_APPEND(KOKKOS_CUDA_OPTIONS -G)
    ENDIF()
  ENDIF()
