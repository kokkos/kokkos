...
function (GET_SVE_HW_VL FLAG)
  ...
  if(DEFINED ENV{SVE_HW_VL})
    ...
    try_run(RUN_GET_SVE_HW_VL COMPILE_GET_SVE_HW_VL
    ...
    if(RUN_GET_SVE_HW_VL EQUAL 0)
     ...
     string(REPLACE     "SVE_HW_VL=" ""      SVE_HW_VL "${SVE_HW_VL}")
      ...
      if(NOT COMPILE_GET_SVE_HW_VL)
        message(WARNING "Performing Test GET_SVE_HW_VL -- failed to compile with flag ${FLAG}: ${COMPILE_OUTPUT_GET_SVE_HW_VL}")
      else()
...
if(KOKKOS_ARCH_ARMV84_SVE)
  ...
  if (COMPILER_SUPPORTS_ARMV84_SVE)
    ...
    compiler_specific_flags(
      ...
      DEFAULT ${KOKKOS_ARCH_ARMV84_SVE_FLAG}
    )
  else()
...
if(KOKKOS_ARCH_NATIVE)
  ...
  elseif(KOKKOS_COMPILER_HAS_ARM_SVE)
    ...
    compiler_specific_flags(
      COMPILER_ID KOKKOS_CXX_HOST_COMPILER_ID
      Clang   ${KOKKOS_NATIVE_FLAGS} -msve-vector-bits=${SVE_HW_VL}
      GNU     ${KOKKOS_NATIVE_FLAGS} -msve-vector-bits=${SVE_HW_VL}
      NVHPC   ${KOKKOS_NATIVE_FLAGS} -msve-vector-bits=${SVE_HW_VL}
      DEFAULT ${KOKKOS_NATIVE_FLAGS} -msve-vector-bits=${SVE_HW_VL}
    )
