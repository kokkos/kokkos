...
CHECK_HOST_ARCH(NATIVE            "local machine")
CHECK_HOST_ARCH(AMDAVX            "AMD chip")
CHECK_HOST_ARCH(ARMV80            "ARMv8.0 Compatible CPU")
CHECK_HOST_ARCH(ARMV81            "ARMv8.1 Compatible CPU")
CHECK_HOST_ARCH(ARMV8_THUNDERX    "ARMv8 Cavium ThunderX CPU")
CHECK_HOST_ARCH(ARMV8_THUNDERX2   "ARMv8 Cavium ThunderX2 CPU")
CHECK_HOST_ARCH(A64FX             "ARMv8.2 with SVE Support")
CHECK_HOST_ARCH(WSM               "Intel Westmere CPU")
CHECK_HOST_ARCH(SNB               "Intel Sandy/Ivy Bridge CPUs")
CHECK_HOST_ARCH(HSW               "Intel Haswell CPUs")
CHECK_HOST_ARCH(BDW               "Intel Broadwell Xeon E-class CPUs")
CHECK_HOST_ARCH(SKX               "Intel Sky Lake Xeon E-class HPC CPUs (AVX512)")
CHECK_HOST_ARCH(KNC               "Intel Knights Corner Xeon Phi")
CHECK_HOST_ARCH(KNL               "Intel Knights Landing Xeon Phi")
CHECK_HOST_ARCH(BGQ               "IBM Blue Gene Q")
CHECK_HOST_ARCH(POWER7            "IBM POWER7 CPUs")
CHECK_HOST_ARCH(POWER8            "IBM POWER8 CPUs")
CHECK_HOST_ARCH(POWER9            "IBM POWER9 CPUs")
CHECK_HOST_ARCH(ZEN               "AMD Zen architecture")
CHECK_HOST_ARCH(ZEN2              "AMD Zen2 architecture")
CHECK_HOST_ARCH(ZEN3              "AMD Zen3 architecture")
