...
FUNCTION(KOKKOS_ARCH_OPTION SUFFIX DEV_TYPE DESCRIPTION)
  ...
  IF (KOKKOS_ARCH_${SUFFIX})
     IF ( ${SUFFIX} MATCHES "[0-9][0-9]" )
        STRING(REGEX REPLACE "[0-9][0-9]" "" GENERIC_ARCH ${SUFFIX})
        SET(KOKKOS_ARCH_${GENERIC_ARCH} ON PARENT_SCOPE)
        MESSAGE(STATUS "Setting KOKKOS_ARCH_${GENERIC_ARCH}=ON from KOKKOS_ARCH_${SUFFIX}")
     ENDIF()
  ENDIF()
...
IF (KOKKOS_ARCH_SNB OR KOKKOS_ARCH_AMDAVX)
  ...
  SET(KOKKOS_ARCH_AVX ON CACHE INTERNAL "AVX architecture")
  IF (KOKKOS_ARCH_SNB)
     SET(KOKKOS_USE_ISA_X86_64 ON CACHE INTERNAL "x86-64 architecture")
  ENDIF()
ENDIF()
