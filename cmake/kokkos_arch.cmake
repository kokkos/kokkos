...
FUNCTION(SET_AND_CHECK_AMD_ARCH ARCH FLAG)
  SET(AMD_ARCHITECTURE ${ARCH} PARENT_SCOPE)
  ...
  IF(KOKKOS_CXX_COMPILER_ID STREQUAL HIPCC)
    ...
    ELSE()
      ...
      IF("${DETECTED_GPU_ARCH}" STREQUAL "gfx900")
        SET_AND_CHECK_AMD_ARCH(VEGA900 ${DETECTED_GPU_ARCH})
      ELSEIF("${DETECTED_GPU_ARCH}" STREQUAL "gfx906")
        SET_AND_CHECK_AMD_ARCH(VEGA906 ${DETECTED_GPU_ARCH})
