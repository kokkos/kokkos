...
FUNCTION(KOKKOS_ENABLE_OPTION SUFFIX DEFAULT DOCSTRING)
  ...
  LIST(APPEND KOKKOS_VALID_OPTIONS ${UC_NAME})
  SET(KOKKOS_VALID_OPTIONS ${KOKKOS_VALID_OPTIONS} PARENT_SCOPE)
ENDFUNCTION()
...
SET(ENABLE_FLAG ON)
# strip enable/disable prefix and validate option name
SET(OPTION_NAME ${UC_NAME})
STRING(REPLACE ENABLE_ "" OPTION_NAME ${OPTION_NAME})
STRING(REPLACE DISABLE_ "" OPTION_NAME ${OPTION_NAME})
IF(NOT OPTION_NAME IN_LIST KOKKOS_VALID_OPTIONS)
    MESSAGE(SEND_ERROR "'${OPTION_NAME}' entry in Kokkos_OPTIONS is not a valid option")
ENDIF()
...
GET_PROPERTY(ENABLE_HELPSTRING CACHE ${ENABLE_NAME} PROPERTY HELPSTRING)
SET(${ENABLE_NAME} ${ENABLE_FLAG} CACHE BOOL ${ENABLE_HELPSTRING} FORCE)
ENDFOREACH()
