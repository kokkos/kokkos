...
KOKKOS_OPTION(CXX_FLAGS "NONE" STRING "CXX_FLAGS passed from user")
IF (NOT KOKKOS_CXX_FLAGS STREQUAL "NONE")
  STRING(REPLACE " " ";" KOKKOS_CXX_FLAGS_LIST "${KOKKOS_CXX_FLAGS}")
  MESSAGE(STATUS "working with Kokkos_CXX_FLAGS: ${KOKKOS_CXX_FLAGS_LIST}")
  SET(NEW_COMPILE_OPTIONS)
  LIST(APPEND NEW_COMPILE_OPTIONS ${KOKKOS_COMPILE_OPTIONS})
  LIST(APPEND NEW_COMPILE_OPTIONS ${KOKKOS_CXX_FLAGS_LIST})
  GLOBAL_SET(KOKKOS_COMPILE_OPTIONS ${NEW_COMPILE_OPTIONS})
ENDIF()

KOKKOS_OPTION(LINK_FLAGS "NONE" STRING "LINK_FLAGS passed from user")
IF (NOT KOKKOS_LINK_FLAGS STREQUAL "NONE")
  STRING(REPLACE " " ";" KOKKOS_LINK_FLAGS_LIST "${KOKKOS_LINK_FLAGS}")
  MESSAGE(STATUS "working with Kokkos_LINK_FLAGS: ${KOKKOS_LINK_FLAGS_LIST}")
  SET(NEW_LINK_OPTIONS)
  LIST(APPEND NEW_LINK_OPTIONS ${KOKKOS_LINK_OPTIONS})
  LIST(APPEND NEW_LINK_OPTIONS ${KOKKOS_LINK_FLAGS_LIST})
