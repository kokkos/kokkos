...
KOKKOS_OPTION(SKIP_VALIDATION OFF BOOL "Whether to skip certain validation checks while testing")
    ...
    FOREACH(OPTION ${SOME_OPTIONS})
      ...
      IF(KOKKOS_ENABLE_${OPTION})
        IF (KOKKOS_SKIP_VALIDATION)
          MESSAGE(STATUS "${SOME_DEVICE} is not active - turning off ${OPTION}")
          SET(KOKKOS_ENABLE_${OPTION} OFF PARENT_SCOPE) #turn it off, don't error out
        ELSE()
          MESSAGE(FATAL_ERROR "Kokkos_ENABLE_${OPTION} is ON but ${SOME_DEVICE} backend is not enabled.")
        ENDIF()
      ENDIF()
    ENDFOREACH()
  ENDIF()
