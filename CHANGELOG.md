...
Add test for resize/realloc with WithoutInitializing [\#4508](https://github.com/kokkos/kokkos/pull/4508)
move min, max, minmax, clamp to math functions #4425 [\#4506](https://github.com/kokkos/kokkos/pull/4506)
Implement Kokkos::sort with execution space [\#4490](https://github.com/kokkos/kokkos/pull/4490)
Add missing denorm_min numeric trait [\#4466](https://github.com/kokkos/kokkos/pull/4466)
Kokkos_Macros: guard deprecation macros for intel<=1900 [\#4465](https://github.com/kokkos/kokkos/pull/4465)
Sorting: add shortcut for integers avoid bin-internal sort [\#4464](https://github.com/kokkos/kokkos/pull/4464)
Algorithms: tests: break up into multiple sets to help build time [\#4456](https://github.com/kokkos/kokkos/pull/4456)
Desul/atomics/Compare_Exchange_GCC: check alignment matches size [\#4451](https://github.com/kokkos/kokkos/pull/4451)
Add missing numeric traits reciprocal_overflow_threshold [\#4473](https://github.com/kokkos/kokkos/pull/4473)
Add missing quiet and signaling NaN numeric traits [\#4443](https://github.com/kokkos/kokkos/pull/4443)
Kokkos_Macros: Fix disable of KOKKOS_DEPRECATED for older intel compi… [\#4476](https://github.com/kokkos/kokkos/pull/4476)

### Implemented enhancements BuildSystem
Add generic KOKKOS_ARCH_VEGA defines [\#4782](https://github.com/kokkos/kokkos/pull/4782)
Correctly identify current compilation pass (host or device) for HIP [\#4761](https://github.com/kokkos/kokkos/pull/4761)
...
Add NVHPC CI build [\#4599](https://github.com/kokkos/kokkos/pull/4599)
change windows.h include to lowercase to improve mingw compatibility [\#4564](https://github.com/kokkos/kokkos/pull/4564)
Use external GoogleTest optionally [\#4563](https://github.com/kokkos/kokkos/pull/4563)
Quiet warnings about multiple optimization flags when they're repetitions of the same argument [\#4502](https://github.com/kokkos/kokkos/pull/4502)
Use the same flags in Makefile.kokkos for POWER7/8/9 as for CMake [\#4483](https://github.com/kokkos/kokkos/pull/4483)
Updated example config file for new spac yaml format [\#4472](https://github.com/kokkos/kokkos/pull/4472)
Add comment for supported Intel GPUs to Makefile.kokkos [\#4460](https://github.com/kokkos/kokkos/pull/4460)
...
Clean up unnecessary #ifdef KOKKOS_ACTIVE_EXECUTION_MEMORY_SPACE_HOST guards [\#4666](https://github.com/kokkos/kokkos/pull/4666)
Drop KOKKOS_IMPL_ENABLE_OVERLOAD_HOST_DEVICE leftovers [\#4661](https://github.com/kokkos/kokkos/pull/4661)
Remove CudaFunctorAdapter [\#4658](https://github.com/kokkos/kokkos/pull/4658)
Remove (unused) Impl::[is_]power_of_two traits [\#4578](https://github.com/kokkos/kokkos/pull/4578)

### Bug Fixes:
Do not call eval, because arguments should not be interpreted and only forwarded [\#4769](https://github.com/kokkos/kokkos/pull/4769)
Fix CI on MI60 [\#4773](https://github.com/kokkos/kokkos/pull/4773)
Fix A64FX flags [\#4745](https://github.com/kokkos/kokkos/pull/4745)
This makes the math function use the "C" interface for GCC 5 [\#4733](https://github.com/kokkos/kokkos/pull/4733)
Fix potential ambiguous specialization in is_CONCEPT macro [\#4729](https://github.com/kokkos/kokkos/pull/4729)
Remove Shared build workaround [\#4725](https://github.com/kokkos/kokkos/pull/4725)
algorithms: fix ambiguous call #4711 [\#4718](https://github.com/kokkos/kokkos/pull/4718)
Do not install empty desul/src/ directory [\#4714](https://github.com/kokkos/kokkos/pull/4714)
Kokkos: Fix SFINAE logic for create_mirror() for specialized types [\#4706](https://github.com/kokkos/kokkos/pull/4706)
Fixup atomic_fetch_{inc,dec}_mod Clang+CUDA on pre-volta architectures [\#4705](https://github.com/kokkos/kokkos/pull/4705)
kokkos_launch_compiler: escape $ character [\#4703](https://github.com/kokkos/kokkos/pull/4703)
Fix wrong device_id computation in identifier_from_devid [\#4694](https://github.com/kokkos/kokkos/pull/4694)
Fix missing target file for HIP Desul Makefile build [\#4674](https://github.com/kokkos/kokkos/pull/4674)
Fix a bug in CUDA scratch memory pool [\#4673](https://github.com/kokkos/kokkos/pull/4673)
Fix deprecation warning in Kokkos_UnorderedMap.hpp [\#4670](https://github.com/kokkos/kokkos/pull/4670)
remove eval of command args in hpcbind [\#4630](https://github.com/kokkos/kokkos/pull/4630)
Return input argument if no GPUs were detected in get_gpu [\#4623](https://github.com/kokkos/kokkos/pull/4623)
Fix Trilinos configuration [\#4610](https://github.com/kokkos/kokkos/pull/4610)
Fix layout_strides::span for rank-0 and add tests [\#4605](https://github.com/kokkos/kokkos/pull/4605)
Ensure calling specialized Kokkos::create_mirror from Kokkos::Impl::create_mirror [\#4602](https://github.com/kokkos/kokkos/pull/4602)
Fixup download CMake >= 3.20 in Dockerfiles [\#4601](https://github.com/kokkos/kokkos/pull/4601)
Fix using sycl::device for IndirectReducerMem [\#4598](https://github.com/kokkos/kokkos/pull/4598)
Change instruction order when initializing tool_arguments from unset_string_option [\#4591](https://github.com/kokkos/kokkos/pull/4591)
Avoid creating a host copy of the reducer [\#4590](https://github.com/kokkos/kokkos/pull/4590)
Fix SYCL atomics for local memory [\#4585](https://github.com/kokkos/kokkos/pull/4585)
Fix Clang-Format job [\#4584](https://github.com/kokkos/kokkos/pull/4584)
Hotfix mdrange_large_deep_copy for SYCL [\#4581](https://github.com/kokkos/kokkos/pull/4581)
Account for Apple's C library implementation having a less accurate erf(long double) [\#4571](https://github.com/kokkos/kokkos/pull/4571)
Fix Kokkos_Sort when using integer and HIP [\#4570](https://github.com/kokkos/kokkos/pull/4570)
Fix compilation error when using HIP with RDC [\#4553](https://github.com/kokkos/kokkos/pull/4553)
OpenMP Target: fix TeamPolicyInternal constructors [\#4535](https://github.com/kokkos/kokkos/pull/4535)
DynamicView: Fix deallocation extent [\#4533](https://github.com/kokkos/kokkos/pull/4533)
Fix running parallel_reduce with TeamPolicy for large ranges [\#4532](https://github.com/kokkos/kokkos/pull/4532)
Fix bash syntax error [\#4524](https://github.com/kokkos/kokkos/pull/4524)
OpenMPTarget team_policy reduce fixes for init/join reductions [\#4521](https://github.com/kokkos/kokkos/pull/4521)
Do not mess with M_PI macro [\#4549](https://github.com/kokkos/kokkos/pull/4549)
Hotfix SYCL to use in-order queues [\#4504](https://github.com/kokkos/kokkos/pull/4504)
Avoid hangs in the Threads backend [\#4499](https://github.com/kokkos/kokkos/pull/4499)
Fix incremental tests for the Threads/PThread backend [\#4496](https://github.com/kokkos/kokkos/pull/4496)
OpenMPTarget: Fix reduction bug in parallel_reduce for TeamPolicy. [\#4491](https://github.com/kokkos/kokkos/pull/4491)
Workaround compiler bug in definition of reciprocal_overflow_threshold [\#4489](https://github.com/kokkos/kokkos/pull/4489)
algorithm: fix for error #4423 [\#4488](https://github.com/kokkos/kokkos/pull/4488)
algorithms: fix intel failure #4424 [\#4480](https://github.com/kokkos/kokkos/pull/4480)
Fix impl_shared_alloc for GPU+threads [\#4478](https://github.com/kokkos/kokkos/pull/4478)
