...
- MD team policy common functions refactor [\#5172](https://github.com/kokkos/kokkos/pull/5172)
- Move min, max, clamp, minmax routines out of Experimental namespace [\#5170](https://github.com/kokkos/kokkos/pull/5170)
- readme: update to slim and use new website [\#5153](https://github.com/kokkos/kokkos/pull/5153)
- Provide ViewCtorProp overload for create_mirror_view_and_copy [\#5125](https://github.com/kokkos/kokkos/pull/5125)
- Allow ViewCtorProp in create_mirror[_view] [\#5095](https://github.com/kokkos/kokkos/pull/5095)
- Update numerics support for __float128 [\#5081](https://github.com/kokkos/kokkos/pull/5081)
- Provide Kokkos::realloc overload taking Kokkos::view_alloc() return type [\#5035](https://github.com/kokkos/kokkos/pull/5035)
- Moving SIMD types into Kokkos [\#5016](https://github.com/kokkos/kokkos/pull/5016)
- Add Sapphire Rapids as architecture [\#5015](https://github.com/kokkos/kokkos/pull/5015)
- Prefer KOKKOS_IF_ON_DEVICE to ifdef __CUDA_ARCH__ in Impl::clock_tic() [\#5014](https://github.com/kokkos/kokkos/pull/5014)
- Add SKL and ICL as architectures [\#5013](https://github.com/kokkos/kokkos/pull/5013)
- complex(math) : log10 support [\#5009](https://github.com/kokkos/kokkos/pull/5009)
...
- Drop volatile from reduce/scan join() routines [\#4931](https://github.com/kokkos/kokkos/pull/4931)
- Add icelake as CPU architecture [\#4929](https://github.com/kokkos/kokkos/pull/4929)
- Allow Kokkos::resize to take an execution space [\#4844](https://github.com/kokkos/kokkos/pull/4844)
- Allow allocate to be called with execution space [\#4826](https://github.com/kokkos/kokkos/pull/4826)
- Implement desired fence behavior for view initialization [\#4823](https://github.com/kokkos/kokkos/pull/4823)
- MD Team Policies Implementation for serial [\#4812](https://github.com/kokkos/kokkos/pull/4812)
- Add Kokkos::create_mirror[_view] WithoutInitializing for Container types [\#4805](https://github.com/kokkos/kokkos/pull/4805)
- Promote mathematical functions to Kokkos namespace [\#4791](https://github.com/kokkos/kokkos/pull/4791)
- More math functions [\#4768](https://github.com/kokkos/kokkos/pull/4768)
- Add base-2/10 switch and iteration arg to [\#4752](https://github.com/kokkos/kokkos/pull/4752)
- Compile time view subscriber and dynamic view hooks [\#4197](https://github.com/kokkos/kokkos/pull/4197)

### Backends and Archs Enhancements:
- Defer gpu id validation to core [\#5253](https://github.com/kokkos/kokkos/pull/5253)
- SYCL: require GPU is GPU architecture is set [\#5264](https://github.com/kokkos/kokkos/pull/5264)
- Initial OpenACC support [\#5249](https://github.com/kokkos/kokkos/pull/5249)
- SYCL: Store device_id passed from initialization [\#5246](https://github.com/kokkos/kokkos/pull/5246)
- Cleanup SYCL device selection [\#5242](https://github.com/kokkos/kokkos/pull/5242)
- sycl_queue member function [\#5241](https://github.com/kokkos/kokkos/pull/5241)
- Harmonize device selection and allow SYCL to circumvent it when no GPU is available [\#5222](https://github.com/kokkos/kokkos/pull/5222)
- OpenMPTarget: Adding a workaound for team scan. [\#5219](https://github.com/kokkos/kokkos/pull/5219)
- Use sycl::device_ptr where appropriate [\#5212](https://github.com/kokkos/kokkos/pull/5212)
- Enable Spaces unit test for HIP [\#5155](https://github.com/kokkos/kokkos/pull/5155)
- Addition of HIPManagedSpace, similar to CudaUVMSpace [\#5112](https://github.com/kokkos/kokkos/pull/5112)
- OpenMPTarget: Adding logic to skip the kernel launch if league_size=0. [\#5067](https://github.com/kokkos/kokkos/pull/5067)
- SYCL: Fence memcpy instead of using in-order queues [\#5065](https://github.com/kokkos/kokkos/pull/5065)
- Enable death tests with HIP for ROCm 5.0.2 and later [\#5049](https://github.com/kokkos/kokkos/pull/5049)
- Force SYCL fallback assert [\#5006](https://github.com/kokkos/kokkos/pull/5006)
- Copy the device for SYCL partition_space [\#4991](https://github.com/kokkos/kokkos/pull/4991)
- OpenMPTarget: Access scratch_memory_space from OpenMPTarget space. [\#4948](https://github.com/kokkos/kokkos/pull/4948)
- Use decorated pointers for m_team_reduce in SYCL [\#4825](https://github.com/kokkos/kokkos/pull/4825)

### Implemented enhancements
- Forward ScopeGuard constructor arguments to initialize [\#5292](https://github.com/kokkos/kokkos/pull/5292)
...
- Avoid using namespace to improve compatibility [\#5244](https://github.com/kokkos/kokkos/pull/5244)
- Check execution spaces interface as they are registered to core [\#5228](https://github.com/kokkos/kokkos/pull/5228)
- Use [[nodiscard]] on ScopeGuard [\#5224](https://github.com/kokkos/kokkos/pull/5224)
- Refactor parsing of command line arguments and environment variables [\#5221](https://github.com/kokkos/kokkos/pull/5221)
- Refactor Threads backend [\#5218](https://github.com/kokkos/kokkos/pull/5218)
- Refactor device selection at initialization [\#5211](https://github.com/kokkos/kokkos/pull/5211)
- Refactor Serial backend [\#5171](https://github.com/kokkos/kokkos/pull/5171)
- Refactor execution space unit test [\#5058](https://github.com/kokkos/kokkos/pull/5058)
- Refactor OpenMP instances and introduce singleton instances [\#5056](https://github.com/kokkos/kokkos/pull/5056)
- Refactor Cuda and HIP specializations of Random_UniqueIndex [\#5023](https://github.com/kokkos/kokkos/pull/5023)
- Assert that layout construction from extents is valid where used [\#5209](https://github.com/kokkos/kokkos/pull/5209)
- Rename tools settings for consistency [\#5201](https://github.com/kokkos/kokkos/pull/5201)
- Implement fill_random with execution space [\#5181](https://github.com/kokkos/kokkos/pull/5181)
- Consolidate all HPX "IndependentInstances" unit tests into a single executable [\#5174](https://github.com/kokkos/kokkos/pull/5174)
...
- Make memory allocated [\#5152](https://github.com/kokkos/kokkos/pull/5152)
- Cleanup/rework fence overloads [\#5148](https://github.com/kokkos/kokkos/pull/5148)
- Revisit ExecSpaceManager and move towards a common API for all execution spaces [\#5144](https://github.com/kokkos/kokkos/pull/5144)
- Avoid using std::iterator in RandomAccessIterator [\#5133](https://github.com/kokkos/kokkos/pull/5133)
- Add unit tests for initialization utilities [\#5126](https://github.com/kokkos/kokkos/pull/5126)
...
- std_algorithms: reorg/split public/impl headers [\#5113](https://github.com/kokkos/kokkos/pull/5113)
- Include KOKKOS_ENABLE_LIBDL in options when the printing configuration [\#5086](https://github.com/kokkos/kokkos/pull/5086)
- Quit using current time as seed for random number generator in unit tests [\#5057](https://github.com/kokkos/kokkos/pull/5057)
- Refactor CudaTeamMember implementation to avoid ifdef __CUDA_ARCH__ [\#5003](https://github.com/kokkos/kokkos/pull/5003)
- Refactor BitOps to not rely on __CUDA_ARCH__ macro [\#5001](https://github.com/kokkos/kokkos/pull/5001)
- Refactor Kokkos_Cuda_Parallel.hpp [\#4822](https://github.com/kokkos/kokkos/pull/4822)
- DynRankView: make layout() return the same as a corresponding static View [\#5026](https://github.com/kokkos/kokkos/pull/5026)
- Replace ifdef __CUDA_ARCH__ in cast_{to,from}_half() [\#5022](https://github.com/kokkos/kokkos/pull/5022)
- Also use _mm_malloc for icpx [\#5012](https://github.com/kokkos/kokkos/pull/5012)
- Rename OpenMPExec to OpenMPInternal in line with the other backends [\#5032](https://github.com/kokkos/kokkos/pull/5032)
- Avoid __CUDA_ARCH__ in Cuda{Texture,LDG}Fetch [\#5010](https://github.com/kokkos/kokkos/pull/5010)
- Drop __CUDA_ARCH__ macro guard in device function cuda_inter_block_reduction [\#5002](https://github.com/kokkos/kokkos/pull/5002)
- Replace remaining occurences of 'typename std::...<>::type' [\#4998](https://github.com/kokkos/kokkos/pull/4998)
- Replace typename std::enable_if<>::type with std::enable_if_t<> [\#4990](https://github.com/kokkos/kokkos/pull/4990)
...
- Replace std::is_same<..., void> with std::is_void<...> [\#4958](https://github.com/kokkos/kokkos/pull/4958)
- Follow-up: clean out volatile methods in Combined Reducer implementation [\#4954](https://github.com/kokkos/kokkos/pull/4954)
- Detect join member function with volatile-qualified arguments [\#4951](https://github.com/kokkos/kokkos/pull/4951)
- Improve error message in view memory access violations [\#4950](https://github.com/kokkos/kokkos/pull/4950)
- algorithms: remove volatile from unit tests [\#4939](https://github.com/kokkos/kokkos/pull/4939)
- Cleanup <stdexcept> header includes [\#4920](https://github.com/kokkos/kokkos/pull/4920)
...
- Use different kernels for 2D and 3D in tutorial/06_simple_mdrangepolicy [\#4912](https://github.com/kokkos/kokkos/pull/4912)
- Check number of bins in BinSort [\#4890](https://github.com/kokkos/kokkos/pull/4890)
- Replace EXPECT_TRUE where sensible [\#4888](https://github.com/kokkos/kokkos/pull/4888)
- Accelerate algorithms/reduce [\#4887](https://github.com/kokkos/kokkos/pull/4887)
- Accelerate scan with trivial initial value [\#4886](https://github.com/kokkos/kokkos/pull/4886)
- Disable memset on A64FX and use parallel init instead [\#4884](https://github.com/kokkos/kokkos/pull/4884)
- Standardize allocation and deallocation for OpenMPTargetSpace [\#4860](https://github.com/kokkos/kokkos/pull/4860)
- CUDA Reductions: Fix data races reported [\#4855](https://github.com/kokkos/kokkos/pull/4855)
- Replace FunctorValueTraits for OpenMPTarget [\#4843](https://github.com/kokkos/kokkos/pull/4843)
- Remove FunctorValueTraits for Cuda [\#4839](https://github.com/kokkos/kokkos/pull/4839)
- Replace FunctorValueTraits for HIP [\#4836](https://github.com/kokkos/kokkos/pull/4836)
- Replace FunctorValueTraits for SYCL [\#4835](https://github.com/kokkos/kokkos/pull/4835)
- Replace FunctorValueTraits for OpenMP [\#4834](https://github.com/kokkos/kokkos/pull/4834)
- Replace FunctorValueTraits for HPX [\#4833](https://github.com/kokkos/kokkos/pull/4833)
- Replace FunctorValueTraits for Threads [\#4832](https://github.com/kokkos/kokkos/pull/4832)
- Split MathematicalFunctions test to reduce memory usage [\#4818](https://github.com/kokkos/kokkos/pull/4818)
- Allow non-power-of-two team sizes for team reductions and scans [\#4809](https://github.com/kokkos/kokkos/pull/4809)
- Make sure Kokkos::abort() causes abnormal program termination when called on the host-side [\#4808](https://github.com/kokkos/kokkos/pull/4808)
- Let SharedAllocationHeader::get_header({void* -> void const*}) [\#4804](https://github.com/kokkos/kokkos/pull/4804)
- Cleanup View access [\#4800](https://github.com/kokkos/kokkos/pull/4800)
- Also limit OMPT's resize_scratch [\#4798](https://github.com/kokkos/kokkos/pull/4798)
- Replace FunctorValueTraits for Serial [\#4774](https://github.com/kokkos/kokkos/pull/4774)
- Avoid macros for CUDA lock arrays [\#4682](https://github.com/kokkos/kokkos/pull/4682)
...
- Loosen restriction for using built-in sycl::group_broadcast [\#4552](https://github.com/kokkos/kokkos/pull/4552)
- SYCL: preserve address space [\#4396](https://github.com/kokkos/kokkos/pull/4396)
- Adding the CUDA_MALLOC_ASYNC option to the Develop BUILD.md options list [\#4274](https://github.com/kokkos/kokkos/pull/4274)
...
- Allow using C++23 [\#5283](https://github.com/kokkos/kokkos/pull/5283)
- Also filter out -pedantic-errors from nvcc options [\#5235](https://github.com/kokkos/kokkos/pull/5235)
- Link libdl as interface library [\#5179](https://github.com/kokkos/kokkos/pull/5179)
- CMake: Only show GPU architectures with enabled corresponding backend [\#5119](https://github.com/kokkos/kokkos/pull/5119)
- Simplify finding an external desul installation [\#5132](https://github.com/kokkos/kokkos/pull/5132)
- Make languages given to CMake project unique [\#5091](https://github.com/kokkos/kokkos/pull/5091)
- Warn instead of just ignoring user settings when kokkos-tools is disabled [\#5088](https://github.com/kokkos/kokkos/pull/5088)
- Change compiler flag for PVC [\#5078](https://github.com/kokkos/kokkos/pull/5078)
- Export Kokkos_CXX_STANDARD variable with CMake [\#5068](https://github.com/kokkos/kokkos/pull/5068)
- Test building with external desul [\#5053](https://github.com/kokkos/kokkos/pull/5053)
- nvcc_wrapper : add known nvcc option --source-in-ptx [\#5052](https://github.com/kokkos/kokkos/pull/5052)
- Last few changes to get all Kokkos UnitTests to compile with nvc++ [\#5039](https://github.com/kokkos/kokkos/pull/5039)
- Suppress warnings with nvc++ [\#5031](https://github.com/kokkos/kokkos/pull/5031)
- Query architecture CUDA code was compiled for with nvc++ [\#5029](https://github.com/kokkos/kokkos/pull/5029)
- Enable optional external desul build [\#5021](https://github.com/kokkos/kokkos/pull/5021)
- Add cmake support for nvc++ as CUDA compiler [\#5020](https://github.com/kokkos/kokkos/pull/5020)
- Check for multiple host architectures in CMake [\#4996](https://github.com/kokkos/kokkos/pull/4996)
...
- CMake modules findtplthreads [\#4940](https://github.com/kokkos/kokkos/pull/4940)
- Add option to optimize for CPU architecture of local machine [\#4930](https://github.com/kokkos/kokkos/pull/4930)
...
- Use -fsycl-device-code-split=per_kernel for SYCL CI [\#4877](https://github.com/kokkos/kokkos/pull/4877)
- Replace amdgpu-target with offload-arch [\#4874](https://github.com/kokkos/kokkos/pull/4874)
- If CMAKE_CXX_COMPILER_LAUNCHER is set , do not enable kokkos_launch_compiler [\#4870](https://github.com/kokkos/kokkos/pull/4870)
- Test with nvcc -Werror [\#4811](https://github.com/kokkos/kokkos/pull/4811)
...
- Remove (unused) Impl::ViewOperatorBoundsErrorAbort [\#5074](https://github.com/kokkos/kokkos/pull/5074)
- Remove KOKKOS_THREAD_LOCAL [\#5064](https://github.com/kokkos/kokkos/pull/5064)
- Remove unused view ctor property Impl::NullSpace_t [\#5036](https://github.com/kokkos/kokkos/pull/5036)
...
- algorithms: remove unused kokkos::exp::move [\#4829](https://github.com/kokkos/kokkos/pull/4829)
- Remove duplicate KOKKOS_IMPL_{HOST,DEVICE}_FUNCTION macro definitions with CUDA [\#4820](https://github.com/kokkos/kokkos/pull/4820)
- Remove Kokkos_FunctorAdapter.hpp [\#4663](https://github.com/kokkos/kokkos/pull/4663)

### Deprecations:
- Raise deprecation warnings if non empty WorkTag class is used [\#5230](https://github.com/kokkos/kokkos/pull/5230)
- Deprecate parallel_* overloads taking the label as later argument [\#5141](https://github.com/kokkos/kokkos/pull/5141)
...
- Fix guards for bogus Intel compiler warning with [[deprecated]] attribute [\#5102](https://github.com/kokkos/kokkos/pull/5102)
- Deprecate useless functions that exists only for the HPX and the OpenMP backend [\#5082](https://github.com/kokkos/kokkos/pull/5082)
- Add Deprecation notice about setting Kokkos_CXX_STANDARD for CMake [\#5066](https://github.com/kokkos/kokkos/pull/5066)
...
- Only test product for bhalf_t for N<=5 [\#5294](https://github.com/kokkos/kokkos/pull/5294)
- DynamicView: Properly resize mirror instances after construction [\#5276](https://github.com/kokkos/kokkos/pull/5276)
- Fix warnings [\#5268](https://github.com/kokkos/kokkos/pull/5268)
...
- Cleanup "Raised [\#5267](https://github.com/kokkos/kokkos/pull/5267)
- Fix CUDA+MSVC build issue [\#5261](https://github.com/kokkos/kokkos/pull/5261)
- Restore old behavior in device selection when user specifies nothing [\#5259](https://github.com/kokkos/kokkos/pull/5259)
- OpenACC select the right device [\#5251](https://github.com/kokkos/kokkos/pull/5251)
- Work around Intel compiler not liking variable template from detection idiom [\#5240](https://github.com/kokkos/kokkos/pull/5240)
- Fixup exp2(long double) -> long double in NVC++ workaround [\#5232](https://github.com/kokkos/kokkos/pull/5232)
...
- Fix Sacado create_mirror_view [\#5198](https://github.com/kokkos/kokkos/pull/5198)
- Fixup bug in boolean options in InitializationSettings [\#5197](https://github.com/kokkos/kokkos/pull/5197)
...
- Drop pointless typename keyword in default template parameter of C-style memory management functions [\#5166](https://github.com/kokkos/kokkos/pull/5166)
- Fix for -Werror=shadow [\#5165](https://github.com/kokkos/kokkos/pull/5165)
- Fix incorrect default inner direction in MD team policy [\#5164](https://github.com/kokkos/kokkos/pull/5164)
- Disable defaultdevicetype_DeathTest::access_forbidden for SYCL temporarily [\#5159](https://github.com/kokkos/kokkos/pull/5159)
- Disable TestViewMemoryAccessViolation for SYCL temporarily [\#5158](https://github.com/kokkos/kokkos/pull/5158)
- Finalize deep_copy_space early avoiding printing to std::cerr for Cuda [\#5151](https://github.com/kokkos/kokkos/pull/5151)
- Fix typo [\#5142](https://github.com/kokkos/kokkos/pull/5142)
- Fix warnings about EnvVarsHelper::operator= not being referenced [\#5137](https://github.com/kokkos/kokkos/pull/5137)
- Use correct policy in Threads MDRange parallel_reduce [\#5123](https://github.com/kokkos/kokkos/pull/5123)
- Fix error message if mismatch between command line arg and env var [\#5116](https://github.com/kokkos/kokkos/pull/5116)
...
- Fix 5097: gcc/7.2.0 ICE in Kokkos_OpenMP_Parallel.hpp [\#5100](https://github.com/kokkos/kokkos/pull/5100)
...
- Fix werror: pointless comparison of unsigned integer with zero [\#5069](https://github.com/kokkos/kokkos/pull/5069)
- Remove stray print statements to stdout in math special functions tests [\#5055](https://github.com/kokkos/kokkos/pull/5055)
- Fix Kokkos::Vector::push_back for default execution space [\#5047](https://github.com/kokkos/kokkos/pull/5047)
- Fix ScatterMin/ScatterMax to use proper atomics [\#5045](https://github.com/kokkos/kokkos/pull/5045)
...
- Suppress class/struct mismatch warning from Clang [\#4969](https://github.com/kokkos/kokkos/pull/4969)
- Fixup join backward compatibility unit test [\#4956](https://github.com/kokkos/kokkos/pull/4956)
- Fix bug in explicit specialization of RuntimeCheckMemoryAccessViolation [\#4946](https://github.com/kokkos/kokkos/pull/4946)
- Fixup Impl::HostSharedPtr tests [\#4945](https://github.com/kokkos/kokkos/pull/4945)
- Fix markdown formatting issue in README.md [\#4928](https://github.com/kokkos/kokkos/pull/4928)
- Workaround Intel compiler bug in string manipulation test [\#4927](https://github.com/kokkos/kokkos/pull/4927)
- Fix typo in comment [\#4923](https://github.com/kokkos/kokkos/pull/4923)
- Fix nextafter(0, 1.f) test for SYCL [\#4922](https://github.com/kokkos/kokkos/pull/4922)
...
- Last few diffs to desul [\#4899](https://github.com/kokkos/kokkos/pull/4899)
- Update trivial desul changes [\#4897](https://github.com/kokkos/kokkos/pull/4897)
...
- Fix typo using CUDA_VERSION macro [\#4850](https://github.com/kokkos/kokkos/pull/4850)
- UniqueToken impl_acquire function should be device only [\#4819](https://github.com/kokkos/kokkos/pull/4819)
- Fix -Werror=pedantic [\#4816](https://github.com/kokkos/kokkos/pull/4816)
- Fix example calls to non existing static print_configuration [\#4806](https://github.com/kokkos/kokkos/pull/4806)
- Fixes for View::operator()() [\#4799](https://github.com/kokkos/kokkos/pull/4799)
- Fix compiler warnings with newest SYCL compiler [\#4739](https://github.com/kokkos/kokkos/pull/4739)
- Fix requests for large team scratch sizes [\#4728](https://github.com/kokkos/kokkos/pull/4728)
- Fix failing detection of view params bugfix [\#4618](https://github.com/kokkos/kokkos/pull/4618)
