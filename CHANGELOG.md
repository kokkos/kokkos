...
- Quad-precision math [\#4098](https://github.com/kokkos/kokkos/pull/4098)
- Adding ExecutionSpace partitioning function [\#4096](https://github.com/kokkos/kokkos/pull/4096)
- Create KokkosExp_InterOp.hpp [\#4065](https://github.com/kokkos/kokkos/pull/4065)
...
- Desul atomics [\#3247](https://github.com/kokkos/kokkos/pull/3247)
- Fence Profiling Support in all backends [\#3966](https://github.com/kokkos/kokkos/pull/3966)

- **Implemented enhancements Backends and Archs:**
- Replace remaining atomics in tasking with seqcst atomics [\#4306](https://github.com/kokkos/kokkos/pull/4306)
- adding KOKKOS_FORCEINLINE_FUNCTION to constbitset constructors [\#4296](https://github.com/kokkos/kokkos/pull/4296)
- Implement partition_space for SYCL [\#4293](https://github.com/kokkos/kokkos/pull/4293)
- Desul NVIDIA ASM Atomics update [\#4282](https://github.com/kokkos/kokkos/pull/4282)
- Use std::memcpy in USMObjectMem instead of placment new [\#4273](https://github.com/kokkos/kokkos/pull/4273)
- Cuda improve heuristic for blocksize [\#4271](https://github.com/kokkos/kokkos/pull/4271)
- Simplify DeepCopy specializations [\#4231](https://github.com/kokkos/kokkos/pull/4231)
...
- Use ZeroMemset in View constructor [\#4226](https://github.com/kokkos/kokkos/pull/4226)
- Add atomic_and and atomic_or tests and wrappers for desul atomics [\#4222](https://github.com/kokkos/kokkos/pull/4222)
- DynRankView: Provide methods to present data as a flat View of requested rank [\#4214](https://github.com/kokkos/kokkos/pull/4214)
...
- Enforce allowing large ranges for SYCL [\#4211](https://github.com/kokkos/kokkos/pull/4211)
...
- Define global ranges according to CUDA in SYCL TeamPolicy [\#4166](https://github.com/kokkos/kokkos/pull/4166)
- Swap x- and z-indices in SYCL MDRangePolicy [\#4161](https://github.com/kokkos/kokkos/pull/4161)
- Update support for cuda reductions to work with types < 4 [\#4156](https://github.com/kokkos/kokkos/pull/4156)
...
- Replace arg_policy.team_size_max with Kokkos::Impl::cuda_get_max_block_size in Cuda::ParallelReduce [\#4142](https://github.com/kokkos/kokkos/pull/4142)
- Desul wrappers adding atomic_assign legacy function support [\#4140](https://github.com/kokkos/kokkos/pull/4140)
- Unorderedmap clear() should zero the size() [\#4130](https://github.com/kokkos/kokkos/pull/4130)
- DynamicView: rewrite without UVM [\#4129](https://github.com/kokkos/kokkos/pull/4129)
- Remove dependency between core and containers [\#4114](https://github.com/kokkos/kokkos/pull/4114)
- Remove core/cmake/KokkosCore_config.h.in [\#4111](https://github.com/kokkos/kokkos/pull/4111)
- Use submit_barrier also for SYCL+CUDA [\#4110](https://github.com/kokkos/kokkos/pull/4110)
- Remove SYCL rotate_right workaround [\#4104](https://github.com/kokkos/kokkos/pull/4104)
- Use DPC++ broadcast extension in SYCL team_broadcast [\#4103](https://github.com/kokkos/kokkos/pull/4103)
- Replace ASSERT_TRUE/FALSE with comparisons [\#4091](https://github.com/kokkos/kokkos/pull/4091)
...
- Update common mathematical functions [\#4043](https://github.com/kokkos/kokkos/pull/4043)
- OpenMPTarget: Set num_teams in the initialize and only for NVIDIA architectures. [\#4042](https://github.com/kokkos/kokkos/pull/4042)
...
- Add missing common mathematical function (absolute value) [\#4036](https://github.com/kokkos/kokkos/pull/4036)
- Add missing complex operations arithmetic types overloads [\#4034](https://github.com/kokkos/kokkos/pull/4034)
- OpenMPTarget: MDRange parallel_reduce [\#4032](https://github.com/kokkos/kokkos/pull/4032)
- Desul atomics with SYCL [\#4031](https://github.com/kokkos/kokkos/pull/4031)
- Adding CudaMallocSync support when using CUDA version >= 11.2 [\#4026](https://github.com/kokkos/kokkos/pull/4026)
- Make policy explicit for SYCL RangePolicy parallel_for implementation [\#3995](https://github.com/kokkos/kokkos/pull/3995)
...
- Prefer std type traits [\#3982](https://github.com/kokkos/kokkos/pull/3982)
- Add detection idiom from the C++ standard library extension version 2 [\#3980](https://github.com/kokkos/kokkos/pull/3980)
- Avoid C-style arrays in Kokkos_ScratchSpace.hpp [\#3958](https://github.com/kokkos/kokkos/pull/3958)
...
- Reuse memory in SYCL parallel_scan [\#3899](https://github.com/kokkos/kokkos/pull/3899)
- Reuse scratch memory in SYCL TeamPolicy [\#3889](https://github.com/kokkos/kokkos/pull/3889)
- [HIP] Add multiple LaunchMechanism [\#3820](https://github.com/kokkos/kokkos/pull/3820)

**Implemented enhancements BuildSystem:**
- Add allow-unsupported-compiler flag to nvcc-wrapper [\#4298](https://github.com/kokkos/kokkos/pull/4298)
- Autogenerate GPU backend specific test files [\#4276](https://github.com/kokkos/kokkos/pull/4276)
- Make sure that KOKKOS_CXX_HOST_COMPILER_ID is defined [\#4235](https://github.com/kokkos/kokkos/pull/4235)
- Change to make CudaMallocAsync available via opt-in with CMake option Kokkos_ENABLE_CUDAMALLOCASYNC [\#4233](https://github.com/kokkos/kokkos/pull/4233)
...
- Replace PGI [\#4196](https://github.com/kokkos/kokkos/pull/4196)
...
- Disable submitting test results to CDash [\#4118](https://github.com/kokkos/kokkos/pull/4118)
- Introduce Kokkos_ENABLE_DEPRECATION_WARNINGS and remove deprecated code with Kokkos_ENABLE_DEPRECATED_CODE_3 [\#4106](https://github.com/kokkos/kokkos/pull/4106)
- Avoid recompilation for auto-generated backend files [\#4068](https://github.com/kokkos/kokkos/pull/4068)
...
- [Trilinos only] Keep quoted compiler flags when passing to Trilinos [\#3987](https://github.com/kokkos/kokkos/pull/3987)
...
- [HIP] Use hipcc architecture autodetection when Kokkos_ARCH is not set [\#3941](https://github.com/kokkos/kokkos/pull/3941)
- Implement option to disable deprecation warnings [\#3855](https://github.com/kokkos/kokkos/pull/3855)
- Complete earlier TMPDIR change [\#3792](https://github.com/kokkos/kokkos/pull/3792)
- Add cppcoreguidelines-pro-type-cstyle-cast to clang-tidy [\#3522](https://github.com/kokkos/kokkos/pull/3522)
- Add sve bit size definition for A64FX [\#3947](https://github.com/kokkos/kokkos/pull/3947)
- Add sve bit size definition for A64FX [\#3946](https://github.com/kokkos/kokkos/pull/3946)

**Implemented enhancements Tools:**
- Replace remaining unnamed fences for SYCL [\#4304](https://github.com/kokkos/kokkos/pull/4304)
- Label all SYCL fences [\#4258](https://github.com/kokkos/kokkos/pull/4258)
- Restore profiling information in View initialization [\#4246](https://github.com/kokkos/kokkos/pull/4246)
- Label more fences [\#4232](https://github.com/kokkos/kokkos/pull/4232)
...
- More nop bs for Intel17 [\#4309](https://github.com/kokkos/kokkos/pull/4309)
- Deprecate CUDA_SAFE_CALL and HIP_SAFE_CALL [\#4249](https://github.com/kokkos/kokkos/pull/4249)
- Deprecate Kokkos::Impl::Timer [\#4201](https://github.com/kokkos/kokkos/pull/4201)
- Remove Kokkos_Cuda_Version_9_8_Compatibility.hpp [\#4190](https://github.com/kokkos/kokkos/pull/4190)
- Cleanup remove unused function global_reduce [\#4189](https://github.com/kokkos/kokkos/pull/4189)
- Remove KOKKOS_IMPL_CUDA_* macros [\#4138](https://github.com/kokkos/kokkos/pull/4138)
- Deprecate Experimental::MasterLock [\#4094](https://github.com/kokkos/kokkos/pull/4094)
- Drop constexpr C++11 workarounds [\#4063](https://github.com/kokkos/kokkos/pull/4063)
- Remove <Kokkos_Tags.hpp> header file [\#4045](https://github.com/kokkos/kokkos/pull/4045)
- Deprecate Kokkos_TaskPolicy.hpp [\#4011](https://github.com/kokkos/kokkos/pull/4011)
- Remove dead code [\#3988](https://github.com/kokkos/kokkos/pull/3988)
- Remove (unused) FunctorApply adapter [\#3984](https://github.com/kokkos/kokkos/pull/3984)
...
**Enabled tests:**
- Enable TestTemplateMetaFunctions [\#4200](https://github.com/kokkos/kokkos/pull/4200)
- Add OpenMPTarget CI build on AMD GPUs [\#4055](https://github.com/kokkos/kokkos/pull/4055)
- Enable more HIP tests [\#4051](https://github.com/kokkos/kokkos/pull/4051)
- Execute TestIncrExecSpace::testit in incremental/Test01_execspace [\#4008](https://github.com/kokkos/kokkos/pull/4008)
- CI: icpx is now part of intel container [\#4002](https://github.com/kokkos/kokkos/pull/4002)
- OpenMPTarget_nvhpc_testing [\#3950](https://github.com/kokkos/kokkos/pull/3950)

**Fixed Bugs:**
- SYCL: Fix race conditions in TeamPolicy::parallel_reduce [\#4418](https://github.com/kokkos/kokkos/pull/4418)
- Kokkos_Serial: Workaround intel ICE issue with Trilinos [\#4411](https://github.com/kokkos/kokkos/pull/4411)
- CUDA MDRange 6D Test: add LaunchBounds [\#4311](https://github.com/kokkos/kokkos/pull/4311)
- Intel 17 atomic illegal instruction fix [\#4299](https://github.com/kokkos/kokkos/pull/4299)
...
- Fix more atomic use in Tasking [\#4269](https://github.com/kokkos/kokkos/pull/4269)
...
- Adding missing fence in task queue [\#4257](https://github.com/kokkos/kokkos/pull/4257)
- Silence warnings about dynamic class in memcpy for HIP launch [\#4256](https://github.com/kokkos/kokkos/pull/4256)
- Kokkos_Cuda.hpp: Fix shadow warning with cuda/11.0 [\#4252](https://github.com/kokkos/kokkos/pull/4252)
- [HIP] Fix issue w/ static initialization of function attributes [\#4242](https://github.com/kokkos/kokkos/pull/4242)
- Avoid warnings for ZeroMemset in View constructor [\#4240](https://github.com/kokkos/kokkos/pull/4240)
- Workaround Intel 17 compiler bug [\#4223](https://github.com/kokkos/kokkos/pull/4223)
...
- Fix thread-safety in HIP [\#4170](https://github.com/kokkos/kokkos/pull/4170)
- Fixes for desul atomics in the OpenMP version. [\#4160](https://github.com/kokkos/kokkos/pull/4160)
...
- Deal with unused variables [\#4148](https://github.com/kokkos/kokkos/pull/4148)
- Fix missing memory fence in tasking [\#4141](https://github.com/kokkos/kokkos/pull/4141)
- Desul fix nightlies [\#4137](https://github.com/kokkos/kokkos/pull/4137)
...
- Remove atomic_compare_exchange_strong in this file as it overloa… [\#4016](https://github.com/kokkos/kokkos/pull/4016)
