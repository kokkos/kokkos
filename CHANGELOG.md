...
- Cuda,HIP: Clean up block size deduction and remove unimplemented lock array free functions [\#3622](https://github.com/kokkos/kokkos/pull/#3622)
- Decrease the number of Fibonacci iterations when using HIP [\#3621](https://github.com/kokkos/kokkos/pull/#3621)
...
- Unify IterateTile.hpp for HIP and CUDA [\#3582](https://github.com/kokkos/kokkos/pull/#3582)
- Add parallel\_scan for SYCL [\#3577](https://github.com/kokkos/kokkos/pull/#3577)
- Cleanup PolicyPropertyAdaptor specializations for WorkItemPropery [\#3574](https://github.com/kokkos/kokkos/pull/#3574)
- Enable container unit tests for SYCL [\#3550](https://github.com/kokkos/kokkos/pull/#3550)
- Avoid rewriting test files when calling cmake [\#3548](https://github.com/kokkos/kokkos/pull/#3548)
- Logical Memory Spaces [\#3546](https://github.com/kokkos/kokkos/pull/#3546)
- SYCL custom reductions [\#3544](https://github.com/kokkos/kokkos/pull/#3544)
- TeamScan for CUDA, Pthreads, OpenMPTarget, HIP [\#3536](https://github.com/kokkos/kokkos/pull/#3536)
...
- Checked narrowing conversion in MDRangePolicy construction [\#3527](https://github.com/kokkos/kokkos/pull/#3527)
- Use the Kokkos Profiling interface rather than the Impl interface [\#3518](https://github.com/kokkos/kokkos/pull/#3518)
- Initialize all data members in RangePolicy default constructor [\#3509](https://github.com/kokkos/kokkos/pull/#3509)
- Cleaned up use of the CUDACC macro [\#3507](https://github.com/kokkos/kokkos/pull/#3507)
- HIP Clean up shuffle reduction in MDRange and in Team [\#3506](https://github.com/kokkos/kokkos/pull/#3506)
- OpenMPTarget: Hierarchial reduction for + operator on scalars [\#3504](https://github.com/kokkos/kokkos/pull/#3504)
- Let MDRangePolicy be semiregular [\#3494](https://github.com/kokkos/kokkos/pull/#3494)
...
- Initial SYCL backend up to level 2 [\#3447](https://github.com/kokkos/kokkos/pull/#3447)
- Add Impl::atomic\_[store,load] to HIP backend [\#3440](https://github.com/kokkos/kokkos/pull/#3440)
- Add half precision base support [\#3439](https://github.com/kokkos/kokkos/pull/#3439)
  - core/Cuda: Remove half\_t -> T implicit conversions [\#3593](https://github.com/kokkos/kokkos/pull/#3593)
...
- CombinedReducers MDRange support [\#3395](https://github.com/kokkos/kokkos/pull/#3395)
...
- Cuda Graph implementation of Kokkos Graphs [\#3369](https://github.com/kokkos/kokkos/pull/#3369)
- Implement multiple occupancy paths for various HIP kernel launchers [\#3366](https://github.com/kokkos/kokkos/pull/#3366)
- Reorganization of Kokkos\_Cuda\_KernelLaunch [\#3363](https://github.com/kokkos/kokkos/pull/#3363)
- Kokkos Graph Interface and Default Implementation [\#3362](https://github.com/kokkos/kokkos/pull/#3362)
- Adding non-public graph dispatch property to AnalyzePolicy [\#3360](https://github.com/kokkos/kokkos/pull/#3360)
...
- Comma operator fold emulation [\#3353](https://github.com/kokkos/kokkos/pull/#3353)
- HIP: MaxThreadsPerBlock clean up [\#3351](https://github.com/kokkos/kokkos/pull/#3351)
...
- Autotuning for TeamPolicy team sizes and vector lengths [\#3206](https://github.com/kokkos/kokkos/pull/#3206)
...
**Fixed bugs:**
- Fix SYCL memory access in allocation [\#3617](https://github.com/kokkos/kokkos/pull/#3617)
...
- Fixup constness change in CUDA Graph API [\#3572](https://github.com/kokkos/kokkos/pull/#3572)
...
- SYCL zero-length reductions [\#3542](https://github.com/kokkos/kokkos/pull/#3542)
...
- Allow passing C++11 flags in nvcc\_wrapper again [\#3429](https://github.com/kokkos/kokkos/pull/#3429)
