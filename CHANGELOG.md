...
* `ATOMICS_BYPASS` handling - test fixes [\#8813](https://github.com/kokkos/kokkos/pull/8813) and Trilinos configuration [\#8816](https://github.com/kokkos/kokkos/pull/8816)
