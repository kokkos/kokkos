 ...
 public:
...

  {
    ...
    if (std::is_same<Kokkos::CudaUVMSpace,
      ...
      typename traits::device_type::memory_space::execution_space().fence("Kokkos::OffsetView::OffsetView(): fence before UVM allocation");
    }
#endif
    //------------------------------------------------------------
    ...
    if (std::is_same<Kokkos::CudaUVMSpace,
                     typename traits::device_type::memory_space>::value) {
      typename traits::device_type::memory_space::execution_space().fence("Kokkos::OffsetView::OffsetView(): fence after UVM allocation");
    }
#endif
    //------------------------------------------------------------
