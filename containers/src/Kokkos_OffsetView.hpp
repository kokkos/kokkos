...
class OffsetView : public View<DataType, Properties...> {
 ...
 public:
  ...
  KOKKOS_FUNCTION int64_t begin(const iType local_dimension) const {
    return local_dimension < base_t::rank() ? m_begins[local_dimension]
 ...
 public:
  ...
  KOKKOS_FUNCTION typename base_t::reference offset_operator(
  ...
  KOKKOS_FUNCTION constexpr typename base_t::reference operator()(
  ...
  KOKKOS_DEFAULTED_FUNCTION
  OffsetView(const OffsetView& rhs) = default;

  KOKKOS_DEFAULTED_FUNCTION
  OffsetView(OffsetView&& rhs) = default;

  KOKKOS_DEFAULTED_FUNCTION
  OffsetView& operator=(const OffsetView& rhs) = default;

  KOKKOS_DEFAULTED_FUNCTION
  OffsetView& operator=(OffsetView&& rhs) = default;
