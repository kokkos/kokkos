...
#define KOKKOS_INVALID_INDEX_RANGE {KOKKOS_INVALID_OFFSET, KOKKOS_INVALID_OFFSET}
   ...
   namespace Impl {
      ...
      struct GetOffsetViewTypeFromViewType {
         ...
         typedef typename OffsetView<typename ViewType::data_type,typename ViewType::array_layout,
               typename ViewType::device_type,typename ViewType::memory_traits>::array_type array_type;
...
#undef KOKKOS_IMPL_OFFSETVIEW_OPERATOR_VERIFY
   ...
   namespace Impl {
      ...
      typename Kokkos::Impl::GetOffsetViewTypeFromViewType<typename Kokkos::Impl::ViewMapping
         ...
         , T0, T1
         >::type >::type
      subview_offset(const Kokkos::OffsetView< D, P... > & src, T0 arg0, T1 arg1) {
