...
class DualView : public ViewTraits<DataType, Properties...> {
 ...
 public:
  ...
  DualView(const DualView<DT, DP...>& src)
      : d_view(src.d_view), h_view(src.h_view) {}
  ...
  inline void clear_sync_state() { modified_flags[1] = modified_flags[0] = 0; }
