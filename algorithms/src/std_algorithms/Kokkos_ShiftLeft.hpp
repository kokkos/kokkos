...
>
IteratorType shift_left(const ExecutionSpace& ex, IteratorType first, IteratorType last,
...
>
KOKKOS_FUNCTION
IteratorType shift_left(const TeamHandleType& teamHandle, IteratorType first,
