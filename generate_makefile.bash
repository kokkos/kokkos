...
display_help_text() {
      ...
      echo "--disable-desul               Disable desul atomics (enabled by default)"
...
if [ "$KOKKOS_DESUL" == "OFF" ]; then
    KOKKOS_DESUL_CMD=-DKokkos_ENABLE_IMPL_DESUL_ATOMICS=OFF
fi
