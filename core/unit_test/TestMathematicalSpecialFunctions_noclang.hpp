...
struct TestComplexErrorFunction {
  ...
  void testit() {
    ...
    for (int i=1; i<5; i++) {
      EXPECT_LE(std::abs(h_erfcx_dbl(i) - h_ref_erfcx_dbl(i)), std::abs(h_ref_erfcx_dbl(i))*1e-13);
    }
  }
...
struct TestComplexBesselJ0Y0Function {
  ...
  KOKKOS_INLINE_FUNCTION
  void operator()(const int & i) const {
    d_cbj0(i) = Kokkos::Experimental::cyl_bessel_j0<Kokkos::complex<double>,double,int>(d_z(i));
    d_cby0(i) = Kokkos::Experimental::cyl_bessel_y0<Kokkos::complex<double>,double,int>(d_z(i));
  }

  KOKKOS_INLINE_FUNCTION
  void operator()( const TestLargeArgTag&, const int & /*i*/ ) const {
    d_cbj0_large(0) = Kokkos::Experimental::cyl_bessel_j0<Kokkos::complex<double>,double,int>(d_z_large(0));
    d_cbj0_large(1) = Kokkos::Experimental::cyl_bessel_j0<Kokkos::complex<double>,double,int>(d_z_large(1),11000,3000);
    d_cbj0_large(2) = Kokkos::Experimental::cyl_bessel_j0<Kokkos::complex<double>,double,int>(d_z_large(2),11000,7500);
    d_cbj0_large(3) = Kokkos::Experimental::cyl_bessel_j0<Kokkos::complex<double>,double,int>(d_z_large(3));
    d_cbj0_large(4) = Kokkos::Experimental::cyl_bessel_j0<Kokkos::complex<double>,double,int>(d_z_large(4),11000,3000);
    d_cbj0_large(5) = Kokkos::Experimental::cyl_bessel_j0<Kokkos::complex<double>,double,int>(d_z_large(5),11000,7500);

    d_cby0_large(0) = Kokkos::Experimental::cyl_bessel_y0<Kokkos::complex<double>,double,int>(d_z_large(0));
    d_cby0_large(1) = Kokkos::Experimental::cyl_bessel_y0<Kokkos::complex<double>,double,int>(d_z_large(1),11000,3000);
    d_cby0_large(2) = Kokkos::Experimental::cyl_bessel_y0<Kokkos::complex<double>,double,int>(d_z_large(2),11000,7500);
    d_cby0_large(3) = Kokkos::Experimental::cyl_bessel_y0<Kokkos::complex<double>,double,int>(d_z_large(3));
    d_cby0_large(4) = Kokkos::Experimental::cyl_bessel_y0<Kokkos::complex<double>,double,int>(d_z_large(4),11000,3000);
    d_cby0_large(5) = Kokkos::Experimental::cyl_bessel_y0<Kokkos::complex<double>,double,int>(d_z_large(5),11000,7500);
  }
};
...
struct TestComplexBesselJ1Y1Function {
  ...
  void testit() {
    ...
    h_ref_cbj1(1)  = Kokkos::complex<double>( 7.801488485792540e-01, -1.260982060238848e+00);
    h_ref_cbj1(2)  = Kokkos::complex<double>( 7.801488485792540e-01, +1.260982060238848e+00);
    h_ref_cbj1(3)  = Kokkos::complex<double>(-7.801488485792543e-01, -1.260982060238848e+00);
    h_ref_cbj1(4)  = Kokkos::complex<double>(-7.801488485792543e-01, +1.260982060238848e+00);
    h_ref_cbj1(5)  = Kokkos::complex<double>(-7.469476253429664e+02, -1.576608505254311e+03);
    h_ref_cbj1(6)  = Kokkos::complex<double>(-7.469476253429664e+02, +1.576608505254311e+03);
    h_ref_cbj1(7)  = Kokkos::complex<double>( 7.469476253429661e+02, -1.576608505254311e+03);
    h_ref_cbj1(8)  = Kokkos::complex<double>( 7.469476253429661e+02, +1.576608505254311e+03);
    h_ref_cbj1(9)  = Kokkos::complex<double>( 3.390589585259365e-01, 0);
    h_ref_cbj1(10) = Kokkos::complex<double>(-3.390589585259365e-01, +3.373499138396203e-17);
    h_ref_cbj1(11) = Kokkos::complex<double>(-3.951932188370151e-02, 0);
    h_ref_cbj1(12) = Kokkos::complex<double>( 3.951932188370151e-02, +7.988560221984213e-18);
    h_ref_cbj1(13) = Kokkos::complex<double>( 1.233147100257312e+03, -1.027302265904111e+03);
    h_ref_cbj1(14) = Kokkos::complex<double>( 1.233147100257312e+03, +1.027302265904111e+03);
    h_ref_cbj1(15) = Kokkos::complex<double>(-1.233147100257312e+03, -1.027302265904111e+03);
    h_ref_cbj1(16) = Kokkos::complex<double>(-1.233147100257312e+03, +1.027302265904111e+03);
    h_ref_cbj1(17) = Kokkos::complex<double>( 4.248029136732908e+02, -1.042364939115052e+03);
    h_ref_cbj1(18) = Kokkos::complex<double>( 4.248029136732908e+02, +1.042364939115052e+03);
    h_ref_cbj1(19) = Kokkos::complex<double>(-4.248029136732909e+02, -1.042364939115052e+03);
    h_ref_cbj1(20) = Kokkos::complex<double>(-4.248029136732909e+02, +1.042364939115052e+03);
    h_ref_cbj1(21) = Kokkos::complex<double>( 1.305514883350938e-01, 0);
    h_ref_cbj1(22) = Kokkos::complex<double>(-1.305514883350938e-01, +7.993709105806192e-18);
    h_ref_cbj1(23) = Kokkos::complex<double>( 4.659838375816632e-02, 0);
    h_ref_cbj1(24) = Kokkos::complex<double>(-4.659838375816632e-02, +6.322680793358811e-18);
  
    h_ref_cby1(0)  = Kokkos::complex<double>(-infinity<double>::value, 0);
    h_ref_cby1(1)  = Kokkos::complex<double>( 1.285849341463599e+00, +7.250812532419394e-01);
    h_ref_cby1(2)  = Kokkos::complex<double>( 1.285849341463599e+00, -7.250812532419394e-01);
    h_ref_cby1(3)  = Kokkos::complex<double>( 1.236114779014097e+00, -8.352164439165690e-01);
    h_ref_cby1(4)  = Kokkos::complex<double>( 1.236114779014097e+00, +8.352164439165690e-01);
    h_ref_cby1(5)  = Kokkos::complex<double>( 1.576608512528508e+03, -7.469476251109801e+02);
    h_ref_cby1(6)  = Kokkos::complex<double>( 1.576608512528508e+03, +7.469476251109801e+02);
    h_ref_cby1(7)  = Kokkos::complex<double>( 1.576608497980113e+03, +7.469476255749524e+02);
    h_ref_cby1(8)  = Kokkos::complex<double>( 1.576608497980113e+03, -7.469476255749524e+02);
    h_ref_cby1(9)  = Kokkos::complex<double>( 3.246744247918000e-01, 0);
    h_ref_cby1(10) = Kokkos::complex<double>(-3.246744247918000e-01, -6.781179170518730e-01);
    h_ref_cby1(11) = Kokkos::complex<double>( 1.616692009926331e-01, 0);
    h_ref_cby1(12) = Kokkos::complex<double>(-1.616692009926332e-01, +7.903864376740302e-02);
    h_ref_cby1(13) = Kokkos::complex<double>( 1.027302268200224e+03, +1.233147093992241e+03);
    h_ref_cby1(14) = Kokkos::complex<double>( 1.027302268200224e+03, -1.233147093992241e+03);
    h_ref_cby1(15) = Kokkos::complex<double>( 1.027302263607999e+03, -1.233147106522383e+03);
    h_ref_cby1(16) = Kokkos::complex<double>( 1.027302263607999e+03, +1.233147106522383e+03);
    h_ref_cby1(17) = Kokkos::complex<double>( 1.042364943073579e+03, +4.248029112344685e+02);
    h_ref_cby1(18) = Kokkos::complex<double>( 1.042364943073579e+03, -4.248029112344685e+02);
    h_ref_cby1(19) = Kokkos::complex<double>( 1.042364935156525e+03, -4.248029161121132e+02);
    h_ref_cby1(20) = Kokkos::complex<double>( 1.042364935156525e+03, +4.248029161121132e+02);
    h_ref_cby1(21) = Kokkos::complex<double>( 7.552212658226459e-02, 0);
    h_ref_cby1(22) = Kokkos::complex<double>(-7.552212658226459e-02, -2.611029766701876e-01);
    h_ref_cby1(23) = Kokkos::complex<double>( 9.186960936986688e-02, 0);
    h_ref_cby1(24) = Kokkos::complex<double>(-9.186960936986688e-02, -9.319676751633262e-02);

    for (int i=0; i<N; i++) {
      EXPECT_LE(Kokkos::abs(h_cbj1(i) - h_ref_cbj1(i)), Kokkos::abs(h_ref_cbj1(i))*1e-13);
    }

    EXPECT_EQ(h_ref_cby1(0), h_cby1(0));
    for (int i=1; i<N; i++) {
      EXPECT_LE(Kokkos::abs(h_cby1(i) - h_ref_cby1(i)), Kokkos::abs(h_ref_cby1(i))*1e-13);
    }
    ...
    h_ref_cbj1_large(0)  = Kokkos::complex<double>( 4.854515317906369e+40, -9.562049455402486e+40);
    h_ref_cbj1_large(1)  = Kokkos::complex<double>(-4.854515317906371e+40, -9.562049455402486e+40);

    h_ref_cby1_large(0)  = Kokkos::complex<double>( 9.562049455402486e+40,  4.854515317906369e+40);
    h_ref_cby1_large(1)  = Kokkos::complex<double>( 9.562049455402486e+40, -4.854515317906369e+40);
   
    EXPECT_TRUE((Kokkos::abs(h_cbj1_large(0) - h_ref_cbj1_large(0)) < Kokkos::abs(h_ref_cbj1_large(0))*1e-12)&&
                (Kokkos::abs(h_cbj1_large(0) - h_ref_cbj1_large(0)) > Kokkos::abs(h_ref_cbj1_large(0))*1e-13));
    EXPECT_TRUE (Kokkos::abs(h_cbj1_large(1) - h_ref_cbj1_large(0)) > Kokkos::abs(h_ref_cbj1_large(0))*1e-6);
    EXPECT_TRUE (Kokkos::abs(h_cbj1_large(2) - h_ref_cbj1_large(0)) < Kokkos::abs(h_ref_cbj1_large(0))*1e-13);
    EXPECT_TRUE((Kokkos::abs(h_cbj1_large(3) - h_ref_cbj1_large(1)) < Kokkos::abs(h_ref_cbj1_large(1))*1e-12)&&
                (Kokkos::abs(h_cbj1_large(3) - h_ref_cbj1_large(1)) > Kokkos::abs(h_ref_cbj1_large(1))*1e-13));
    EXPECT_TRUE (Kokkos::abs(h_cbj1_large(4) - h_ref_cbj1_large(1)) > Kokkos::abs(h_ref_cbj1_large(1))*1e-6);
    EXPECT_TRUE (Kokkos::abs(h_cbj1_large(5) - h_ref_cbj1_large(1)) < Kokkos::abs(h_ref_cbj1_large(1))*1e-13);
	
    EXPECT_TRUE((Kokkos::abs(h_cby1_large(0) - h_ref_cby1_large(0)) < Kokkos::abs(h_ref_cby1_large(0))*1e-12)&&
                (Kokkos::abs(h_cby1_large(0) - h_ref_cby1_large(0)) > Kokkos::abs(h_ref_cby1_large(0))*1e-13));
    EXPECT_TRUE (Kokkos::abs(h_cby1_large(1) - h_ref_cby1_large(0)) > Kokkos::abs(h_ref_cby1_large(0))*1e-6);
    EXPECT_TRUE (Kokkos::abs(h_cby1_large(2) - h_ref_cby1_large(0)) < Kokkos::abs(h_ref_cby1_large(0))*1e-13);
    EXPECT_TRUE((Kokkos::abs(h_cby1_large(3) - h_ref_cby1_large(1)) < Kokkos::abs(h_ref_cby1_large(1))*1e-12)&&
                (Kokkos::abs(h_cby1_large(3) - h_ref_cby1_large(1)) > Kokkos::abs(h_ref_cby1_large(1))*1e-13));
    EXPECT_TRUE (Kokkos::abs(h_cby1_large(4) - h_ref_cby1_large(1)) > Kokkos::abs(h_ref_cby1_large(1))*1e-6);
    EXPECT_TRUE (Kokkos::abs(h_cby1_large(5) - h_ref_cby1_large(1)) < Kokkos::abs(h_ref_cby1_large(1))*1e-13);
  }

  KOKKOS_INLINE_FUNCTION
  void operator()(const int & i) const {
    d_cbj1(i)  = Kokkos::Experimental::cyl_bessel_j1<Kokkos::complex<double>,double,int>(d_z(i));
    d_cby1(i)  = Kokkos::Experimental::cyl_bessel_y1<Kokkos::complex<double>,double,int>(d_z(i));
  }

  KOKKOS_INLINE_FUNCTION
  void operator()( const TestLargeArgTag&, const int & /*i*/ ) const {
    d_cbj1_large(0) = Kokkos::Experimental::cyl_bessel_j1<Kokkos::complex<double>,double,int>(d_z_large(0));
    d_cbj1_large(1) = Kokkos::Experimental::cyl_bessel_j1<Kokkos::complex<double>,double,int>(d_z_large(1),11000,3000);
    d_cbj1_large(2) = Kokkos::Experimental::cyl_bessel_j1<Kokkos::complex<double>,double,int>(d_z_large(2),11000,7500);
    d_cbj1_large(3) = Kokkos::Experimental::cyl_bessel_j1<Kokkos::complex<double>,double,int>(d_z_large(3));
    d_cbj1_large(4) = Kokkos::Experimental::cyl_bessel_j1<Kokkos::complex<double>,double,int>(d_z_large(4),11000,3000);
    d_cbj1_large(5) = Kokkos::Experimental::cyl_bessel_j1<Kokkos::complex<double>,double,int>(d_z_large(5),11000,7500);

    d_cby1_large(0) = Kokkos::Experimental::cyl_bessel_y1<Kokkos::complex<double>,double,int>(d_z_large(0));
    d_cby1_large(1) = Kokkos::Experimental::cyl_bessel_y1<Kokkos::complex<double>,double,int>(d_z_large(1),11000,3000);
    d_cby1_large(2) = Kokkos::Experimental::cyl_bessel_y1<Kokkos::complex<double>,double,int>(d_z_large(2),11000,7500);
    d_cby1_large(3) = Kokkos::Experimental::cyl_bessel_y1<Kokkos::complex<double>,double,int>(d_z_large(3));
    d_cby1_large(4) = Kokkos::Experimental::cyl_bessel_y1<Kokkos::complex<double>,double,int>(d_z_large(4),11000,3000);
    d_cby1_large(5) = Kokkos::Experimental::cyl_bessel_y1<Kokkos::complex<double>,double,int>(d_z_large(5),11000,7500);
  }
};
...
struct TestComplexBesselI0K0Function {
  ...
  void testit() {
    ...
    h_ref_cbi0(1)  = Kokkos::complex<double>(-4.695171920440706e-01, +4.313788409468920e+00);
    h_ref_cbi0(2)  = Kokkos::complex<double>(-4.695171920440706e-01, -4.313788409468920e+00);
    h_ref_cbi0(3)  = Kokkos::complex<double>(-4.695171920440706e-01, -4.313788409468920e+00);
    h_ref_cbi0(4)  = Kokkos::complex<double>(-4.695171920440706e-01, +4.313788409468920e+00);
    h_ref_cbi0(5)  = Kokkos::complex<double>(-7.276526052028507e+08, -2.806354803468570e+08);
    h_ref_cbi0(6)  = Kokkos::complex<double>(-7.276526052028507e+08, +2.806354803468570e+08);
    h_ref_cbi0(7)  = Kokkos::complex<double>(-7.276526052028507e+08, +2.806354803468570e+08);
    h_ref_cbi0(8)  = Kokkos::complex<double>(-7.276526052028507e+08, -2.806354803468570e+08);
    ...
    h_ref_cbi0(13) = Kokkos::complex<double>(-9.775983282455373e+10, -4.159160389327644e+10);
    h_ref_cbi0(14) = Kokkos::complex<double>(-9.775983282455373e+10, +4.159160389327644e+10);
    h_ref_cbi0(15) = Kokkos::complex<double>(-9.775983282455373e+10, +4.159160389327644e+10);
    h_ref_cbi0(16) = Kokkos::complex<double>(-9.775983282455373e+10, -4.159160389327644e+10);
    h_ref_cbi0(17) = Kokkos::complex<double>(-5.158377566681892e+24, -2.766704059464302e+24);
    h_ref_cbi0(18) = Kokkos::complex<double>(-5.158377566681892e+24, +2.766704059464302e+24);
    h_ref_cbi0(19) = Kokkos::complex<double>(-5.158377566681892e+24, +2.766704059464302e+24);
    h_ref_cbi0(20) = Kokkos::complex<double>(-5.158377566681892e+24, -2.766704059464302e+24);
    ...
    h_ref_cbk0(1)  = Kokkos::complex<double>(-2.078722558742977e-02, -2.431266356716766e-02);
    h_ref_cbk0(2)  = Kokkos::complex<double>(-2.078722558742977e-02, +2.431266356716766e-02);
    h_ref_cbk0(3)  = Kokkos::complex<double>(-1.357295320191579e+01, +1.499344424826928e+00);
    h_ref_cbk0(4)  = Kokkos::complex<double>(-1.357295320191579e+01, -1.499344424826928e+00);
    h_ref_cbk0(5)  = Kokkos::complex<double>(-1.820476218131465e-11, +1.795056004780177e-11);
    h_ref_cbk0(6)  = Kokkos::complex<double>(-1.820476218131465e-11, -1.795056004780177e-11);
    h_ref_cbk0(7)  = Kokkos::complex<double>( 8.816423633943287e+08, +2.285988078870750e+09);
    h_ref_cbk0(8)  = Kokkos::complex<double>( 8.816423633943287e+08, -2.285988078870750e+09);
    h_ref_cbk0(9)  = Kokkos::complex<double>( 3.473950438627926e-02, 0);
    h_ref_cbk0(10) = Kokkos::complex<double>( 3.473950438627926e-02, -1.533346213144909e+01);
    h_ref_cbk0(11) = Kokkos::complex<double>( 2.667545110351910e-11, 0);
    h_ref_cbk0(12) = Kokkos::complex<double>( 2.667545110351910e-11, -2.560844503718094e+09);
    h_ref_cbk0(13) = Kokkos::complex<double>(-1.163319528590747e-13, +1.073711234918388e-13);
    h_ref_cbk0(14) = Kokkos::complex<double>(-1.163319528590747e-13, -1.073711234918388e-13);
    h_ref_cbk0(15) = Kokkos::complex<double>( 1.306638772421339e+11, +3.071215726177843e+11);
    h_ref_cbk0(16) = Kokkos::complex<double>( 1.306638772421339e+11, -3.071215726177843e+11);
    h_ref_cbk0(17) = Kokkos::complex<double>(-1.111584549467388e-27, +8.581979311477652e-28);
    h_ref_cbk0(18) = Kokkos::complex<double>(-1.111584549467388e-27, -8.581979311477652e-28);
    h_ref_cbk0(19) = Kokkos::complex<double>( 8.691857147870108e+24, +1.620552106793022e+25);
    h_ref_cbk0(20) = Kokkos::complex<double>( 8.691857147870108e+24, -1.620552106793022e+25);
    h_ref_cbk0(21) = Kokkos::complex<double>( 1.630534586888181e-13, 0);
    h_ref_cbk0(22) = Kokkos::complex<double>( 1.630534586888181e-13, -3.441131095391506e+11);
    h_ref_cbk0(23) = Kokkos::complex<double>( 1.413897840559108e-27, 0);
    h_ref_cbk0(24) = Kokkos::complex<double>( 1.413897840559108e-27, -1.851678917759592e+25);

    for (int i=0; i<N; i++) {
      EXPECT_LE(Kokkos::abs(h_cbi0(i) - h_ref_cbi0(i)), Kokkos::abs(h_ref_cbi0(i))*1e-13);
    }

    EXPECT_EQ(h_ref_cbk0(0), h_cbk0(0));
    for (int i=1; i<N; i++) {
      EXPECT_LE(Kokkos::abs(h_cbk0(i) - h_ref_cbk0(i)), Kokkos::abs(h_ref_cbk0(i))*1e-13);
    }
    ...
    h_ref_cbi0_large(0) = Kokkos::complex<double>(-9.266819049505678e+41, -5.370779383266049e+41);
    h_ref_cbi0_large(1) = Kokkos::complex<double>(-9.266819049505678e+41, +5.370779383266049e+41);
  
    EXPECT_TRUE (Kokkos::abs(h_cbi0_large(0) - h_ref_cbi0_large(0)) < Kokkos::abs(h_ref_cbi0_large(0))*1e-15);
    EXPECT_TRUE (Kokkos::abs(h_cbi0_large(1) - h_ref_cbi0_large(0)) > Kokkos::abs(h_ref_cbi0_large(0))*1e-4);
    EXPECT_TRUE (Kokkos::abs(h_cbi0_large(2) - h_ref_cbi0_large(0)) < Kokkos::abs(h_ref_cbi0_large(0))*1e-15);
    EXPECT_TRUE (Kokkos::abs(h_cbi0_large(3) - h_ref_cbi0_large(1)) < Kokkos::abs(h_ref_cbi0_large(1))*1e-15);
    EXPECT_TRUE (Kokkos::abs(h_cbi0_large(4) - h_ref_cbi0_large(1)) > Kokkos::abs(h_ref_cbi0_large(1))*1e-4);
    EXPECT_TRUE (Kokkos::abs(h_cbi0_large(5) - h_ref_cbi0_large(1)) < Kokkos::abs(h_ref_cbi0_large(1))*1e-15);
  }

  KOKKOS_INLINE_FUNCTION
  void operator()(const int & i) const {
    d_cbi0(i) = Kokkos::Experimental::cyl_bessel_i0<Kokkos::complex<double>,double,int>(d_z(i));
    d_cbk0(i) = Kokkos::Experimental::cyl_bessel_k0<Kokkos::complex<double>,double,int>(d_z(i));
  }

  KOKKOS_INLINE_FUNCTION
  void operator()( const TestLargeArgTag&, const int & /*i*/ ) const {
    d_cbi0_large(0) = Kokkos::Experimental::cyl_bessel_i0<Kokkos::complex<double>,double,int>(d_z_large(0));
    d_cbi0_large(1) = Kokkos::Experimental::cyl_bessel_i0<Kokkos::complex<double>,double,int>(d_z_large(1),110,35);
    d_cbi0_large(2) = Kokkos::Experimental::cyl_bessel_i0<Kokkos::complex<double>,double,int>(d_z_large(2),110,190);
    d_cbi0_large(3) = Kokkos::Experimental::cyl_bessel_i0<Kokkos::complex<double>,double,int>(d_z_large(3));
    d_cbi0_large(4) = Kokkos::Experimental::cyl_bessel_i0<Kokkos::complex<double>,double,int>(d_z_large(4),110,35);
    d_cbi0_large(5) = Kokkos::Experimental::cyl_bessel_i0<Kokkos::complex<double>,double,int>(d_z_large(5),110,190);
  }
};
...
struct TestComplexBesselI1K1Function {
  ...
  void testit() {
    ...
    h_ref_cbi1(1)  = Kokkos::complex<double>(-8.127809410735776e-01, +3.780682961371298e+00);
    h_ref_cbi1(2)  = Kokkos::complex<double>(-8.127809410735776e-01, -3.780682961371298e+00);
    h_ref_cbi1(3)  = Kokkos::complex<double>( 8.127809410735776e-01, +3.780682961371298e+00);
    h_ref_cbi1(4)  = Kokkos::complex<double>( 8.127809410735776e-01, -3.780682961371298e+00);
    h_ref_cbi1(5)  = Kokkos::complex<double>(-7.119745937677552e+08, -2.813616375214342e+08);
    h_ref_cbi1(6)  = Kokkos::complex<double>(-7.119745937677552e+08, +2.813616375214342e+08);
    h_ref_cbi1(7)  = Kokkos::complex<double>( 7.119745937677552e+08, -2.813616375214342e+08);
    h_ref_cbi1(8)  = Kokkos::complex<double>( 7.119745937677552e+08, +2.813616375214342e+08);
    ...
    h_ref_cbi1(13) = Kokkos::complex<double>(-9.596150723281404e+10, -4.149038020045121e+10);
    h_ref_cbi1(14) = Kokkos::complex<double>(-9.596150723281404e+10, +4.149038020045121e+10);
    h_ref_cbi1(15) = Kokkos::complex<double>( 9.596150723281404e+10, -4.149038020045121e+10);
    h_ref_cbi1(16) = Kokkos::complex<double>( 9.596150723281404e+10, +4.149038020045121e+10);
    h_ref_cbi1(17) = Kokkos::complex<double>(-5.112615594220387e+24, -2.751210232069100e+24);
    h_ref_cbi1(18) = Kokkos::complex<double>(-5.112615594220387e+24, +2.751210232069100e+24);
    h_ref_cbi1(19) = Kokkos::complex<double>( 5.112615594220387e+24, -2.751210232069100e+24);
    h_ref_cbi1(20) = Kokkos::complex<double>( 5.112615594220387e+24, +2.751210232069100e+24);
    ...
    h_ref_cbk1(1)  = Kokkos::complex<double>(-2.480952007015153e-02, -2.557074905635180e-02);
    h_ref_cbk1(2)  = Kokkos::complex<double>(-2.480952007015153e-02, +2.557074905635180e-02);
    h_ref_cbk1(3)  = Kokkos::complex<double>(-1.185255629692602e+01, +2.527855884398198e+00);
    h_ref_cbk1(4)  = Kokkos::complex<double>(-1.185255629692602e+01, -2.527855884398198e+00);
    h_ref_cbk1(5)  = Kokkos::complex<double>(-1.839497240093994e-11, +1.841855854336314e-11);
    h_ref_cbk1(6)  = Kokkos::complex<double>(-1.839497240093994e-11, -1.841855854336314e-11);
    h_ref_cbk1(7)  = Kokkos::complex<double>( 8.839236534393319e+08, +2.236734153323357e+09);
    h_ref_cbk1(8)  = Kokkos::complex<double>( 8.839236534393319e+08, -2.236734153323357e+09);
    h_ref_cbk1(9)  = Kokkos::complex<double>( 4.015643112819419e-02, 0);
    h_ref_cbk1(10) = Kokkos::complex<double>(-4.015643112819419e-02, -1.241987883191272e+01);
    h_ref_cbk1(11) = Kokkos::complex<double>( 2.724930589574976e-11, 0);
    h_ref_cbk1(12) = Kokkos::complex<double>(-2.724930589574976e-11, -2.504540577257910e+09);
    h_ref_cbk1(13) = Kokkos::complex<double>(-1.175637676331817e-13, +1.097080943197297e-13);
    h_ref_cbk1(14) = Kokkos::complex<double>(-1.175637676331817e-13, -1.097080943197297e-13);
    h_ref_cbk1(15) = Kokkos::complex<double>( 1.303458736323849e+11, +3.014719661500124e+11);
    h_ref_cbk1(16) = Kokkos::complex<double>( 1.303458736323849e+11, -3.014719661500124e+11);
    h_ref_cbk1(17) = Kokkos::complex<double>(-1.119411861396158e-27, +8.666195226392352e-28);
    h_ref_cbk1(18) = Kokkos::complex<double>(-1.119411861396158e-27, -8.666195226392352e-28);
    h_ref_cbk1(19) = Kokkos::complex<double>( 8.643181853549355e+24, +1.606175559143138e+25);
    h_ref_cbk1(20) = Kokkos::complex<double>( 8.643181853549355e+24, -1.606175559143138e+25);
    h_ref_cbk1(21) = Kokkos::complex<double>( 1.659400107332009e-13, 0);
    h_ref_cbk1(22) = Kokkos::complex<double>(-1.659400107332009e-13, -3.379112898365253e+11);
    h_ref_cbk1(23) = Kokkos::complex<double>( 1.425632026517104e-27, 0);
    h_ref_cbk1(24) = Kokkos::complex<double>(-1.425632026517104e-27, -1.836182865214478e+25);
  
    for (int i=0; i<N; i++) {
      EXPECT_LE(Kokkos::abs(h_cbi1(i) - h_ref_cbi1(i)), Kokkos::abs(h_ref_cbi1(i))*1e-13);
    }

    EXPECT_EQ(h_ref_cbk1(0), h_cbk1(0));
    for (int i=1; i<N; i++) {
      EXPECT_LE(Kokkos::abs(h_cbk1(i) - h_ref_cbk1(i)), Kokkos::abs(h_ref_cbk1(i))*1e-13);
    }
    ...
    h_ref_cbi1_large(0) = Kokkos::complex<double>(-9.218158020154234e+41, -5.348736158968607e+41);
    h_ref_cbi1_large(1) = Kokkos::complex<double>( 9.218158020154234e+41, -5.348736158968607e+41);
	
    EXPECT_TRUE (Kokkos::abs(h_cbi1_large(0) - h_ref_cbi1_large(0)) < Kokkos::abs(h_ref_cbi1_large(0))*1e-15);
    EXPECT_TRUE (Kokkos::abs(h_cbi1_large(1) - h_ref_cbi1_large(0)) > Kokkos::abs(h_ref_cbi1_large(0))*1e-4);
    EXPECT_TRUE (Kokkos::abs(h_cbi1_large(2) - h_ref_cbi1_large(0)) < Kokkos::abs(h_ref_cbi1_large(0))*1e-15);
    EXPECT_TRUE (Kokkos::abs(h_cbi1_large(3) - h_ref_cbi1_large(1)) < Kokkos::abs(h_ref_cbi1_large(1))*1e-15);
    EXPECT_TRUE (Kokkos::abs(h_cbi1_large(4) - h_ref_cbi1_large(1)) > Kokkos::abs(h_ref_cbi1_large(1))*1e-4);
    EXPECT_TRUE (Kokkos::abs(h_cbi1_large(5) - h_ref_cbi1_large(1)) < Kokkos::abs(h_ref_cbi1_large(1))*1e-15);
  }

  KOKKOS_INLINE_FUNCTION
  void operator()(const int & i) const {
    d_cbi1(i) = Kokkos::Experimental::cyl_bessel_i1<Kokkos::complex<double>,double,int>(d_z(i));
    d_cbk1(i) = Kokkos::Experimental::cyl_bessel_k1<Kokkos::complex<double>,double,int>(d_z(i));
  }

  KOKKOS_INLINE_FUNCTION
  void operator()( const TestLargeArgTag&, const int & /*i*/ ) const {
    d_cbi1_large(0) = Kokkos::Experimental::cyl_bessel_i1<Kokkos::complex<double>,double,int>(d_z_large(0));
    d_cbi1_large(1) = Kokkos::Experimental::cyl_bessel_i1<Kokkos::complex<double>,double,int>(d_z_large(1),110,35);
    d_cbi1_large(2) = Kokkos::Experimental::cyl_bessel_i1<Kokkos::complex<double>,double,int>(d_z_large(2),110,190);
    d_cbi1_large(3) = Kokkos::Experimental::cyl_bessel_i1<Kokkos::complex<double>,double,int>(d_z_large(3));
    d_cbi1_large(4) = Kokkos::Experimental::cyl_bessel_i1<Kokkos::complex<double>,double,int>(d_z_large(4),110,35);
    d_cbi1_large(5) = Kokkos::Experimental::cyl_bessel_i1<Kokkos::complex<double>,double,int>(d_z_large(5),110,190);
  }
};
...
struct TestComplexBesselH1Function {
  ...
  void testit() {
    ...
    std::cout << "h_ch10(0): " << h_ch10(0) << ", h_ref_ch10(0): " << h_ref_ch10(0) << std::endl;
    for (int i=1; i<N; i++) {
      EXPECT_LE(Kokkos::abs(h_ch10(i) - h_ref_ch10(i)), Kokkos::abs(h_ref_ch10(i))*1e-13);
      std::cout << i << ", actual diff: " << Kokkos::abs(h_ch10(i) - h_ref_ch10(i)) << ", expected diff: " << Kokkos::abs(h_ref_ch10(i))*1e-13 << std::endl;
    }

    EXPECT_EQ(h_ref_ch11(0), h_ch11(0));
    std::cout << "h_ch11(0): " << h_ch11(0) << ", h_ref_ch11(0): " << h_ref_ch11(0) << std::endl;
    for (int i=1; i<N; i++) {
      EXPECT_LE(Kokkos::abs(h_ch11(i) - h_ref_ch11(i)), Kokkos::abs(h_ref_ch11(i))*1e-13);
      std::cout << i << ", actual diff: " << Kokkos::abs(h_ch11(i) - h_ref_ch11(i)) << ", expected diff: " << Kokkos::abs(h_ref_ch11(i))*1e-13 << std::endl;
    }
  }
