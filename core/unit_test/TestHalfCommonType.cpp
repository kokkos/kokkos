...
template <class T>
constexpr bool check_common_types() {
...
static_assert(check_common_types<Kokkos::Experimental::half_t>());
#endif
#if defined(__STDCPP_FLOAT16_T__)
static_assert(check_common_types<std::float16_t>());
#endif
#if !KOKKOS_BHALF_T_IS_FLOAT
static_assert(check_common_types<Kokkos::Experimental::bhalf_t>());
#endif
...
static_assert(check_common_types_both<Kokkos::Experimental::half_t, Kokkos::Experimental::bhalf_t>());
#endif
#if defined(__STDCPP_FLOAT16_T__) && defined(__STDCPP_BFLOAT16_T__)
static_assert(check_common_types_both<std::float16_t, std::bfloat16_t>());
#endif
