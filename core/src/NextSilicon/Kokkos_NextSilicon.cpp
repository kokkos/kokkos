...
void Kokkos::Experimental::NextSilicon::print_configuration(
  ...
  os << "  KOKKOS_ENABLE_IMPL_NEXTSILICON_ADD_TELEM_REGIONS: ";
#ifdef KOKKOS_ENABLE_IMPL_NEXTSILICON_ADD_TELEM_REGIONS
  os << "yes\n";
#else
  os << "no\n";
#endif
  os << "  KOKKOS_ENABLE_IMPL_NEXTSILICON_UNIFIED_MEMORY: ";
#ifdef KOKKOS_ENABLE_IMPL_NEXTSILICON_UNIFIED_MEMORY
  os << "yes\n";
#else
  os << "no\n";
#endif
  os << "  KOKKOS_ENABLE_IMPL_NEXTSILICON_DISTRIBUTE_MEMORY: ";
#ifdef KOKKOS_ENABLE_IMPL_NEXTSILICON_DISTRIBUTE_MEMORY
  os << "yes\n";
#else
  os << "no\n";
#endif
