...
void OpenMPTargetInternal::print_configuration(std::ostream & stream, const bool) {
...
int  OpenMPTargetInternal::impl_is_initialized() { return m_is_initialized?1:0; } 
...
OpenMPTarget::OpenMPTarget():m_space_instance(Impl::OpenMPTargetInternal::impl_singleton()) {}
OpenMPTarget::~OpenMPTarget() {}

const char* OpenMPTarget::name() { return Impl::OpenMPTargetInternal::impl_singleton()->name(); }
void OpenMPTarget::print_configuration(std::ostream & stream, const bool detail) {            
  m_space_instance->print_configuration(stream,detail);
}

int  OpenMPTarget::concurrency() { return Impl::OpenMPTargetInternal::impl_singleton()->concurrency(); }
void OpenMPTarget::fence() { Impl::OpenMPTargetInternal::impl_singleton()->fence(); }
...
int  OpenMPTarget::impl_is_initialized() { return Impl::OpenMPTargetInternal::impl_singleton()->impl_is_initialized(); } 
} // Namespace Experimental
} // Namespace Kokkos
