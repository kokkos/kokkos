...
struct GraphNodeDeepCopyImpl;

template <typename T, class Enable = void>
struct is_graph_deep_copy : public std::false_type {};

template <typename T>
inline constexpr bool is_graph_deep_copy_v = is_graph_deep_copy<T>::value;

struct _graph_node_kernel_ctor_tag {};
struct _graph_node_capture_ctor_tag {};
struct _graph_node_deep_copy_ctor_tag {};
