...
file = NULL, const int line = 0 );

inline void sycl_internal_safe_call( syclError_t e , const char * name, const
char * file = NULL, const int line = 0)
{
...
#define SYCL_SAFE_CALL(call) call
