...
struct MDSpanLayoutFromLayoutType {
  using type = void;
};

template <>
struct MDSpanLayoutFromLayoutType<LayoutLeft> {
  using type = Experimental::layout_left_padded<dynamic_extent>;
};

template <>
struct MDSpanLayoutFromLayoutType<LayoutRight> {
  using type = Experimental::layout_right_padded<dynamic_extent>;
};

template <>
struct MDSpanLayoutFromLayoutType<LayoutStride> {
