...
#ifndef KOKKOS_SIMD_PERFTEST_BENCHMARK_CONTEXT_HPP
#define KOKKOS_SIMD_PERFTEST_BENCHMARK_CONTEXT_HPP
...
void report_results(benchmark::State& state, ViewType view, int data_ratio,
  ...
  const double data_processed =
      (data_ratio * view.size() * sizeof(typename ViewType::value_type)) /
      1'000'000.;
