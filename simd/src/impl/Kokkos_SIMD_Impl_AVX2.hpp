...
KOKKOS_SIMD_IMPL_SIMD_HOST_VECTOR_IMPL(float, simd_abi::avx2_fixed_size<8>, __m256)
...
struct simd_mask_native_ops<float, simd_abi::avx2_fixed_size<4>, simd_device_tag> {
  using vector_type = simd_vector_t<float, simd_abi::avx2_fixed_size<4>, simd_device_tag>;
  using value_type = bool;
...
struct simd_mask_native_ops<float, simd_abi::avx2_fixed_size<8>, simd_device_tag> {
  using vector_type = simd_vector_t<float, simd_abi::avx2_fixed_size<8>, simd_device_tag>;
  using value_type = bool;
...
struct simd_mask_native_ops<std::int32_t, simd_abi::avx2_fixed_size<4>, simd_device_tag> {
  using vector_type = simd_vector_t<std::int32_t, simd_abi::avx2_fixed_size<4>, simd_device_tag>;
  using value_type = bool;
...
struct simd_mask_native_ops<std::int32_t, simd_abi::avx2_fixed_size<8>, simd_device_tag> {
  using vector_type = simd_vector_t<std::int32_t, simd_abi::avx2_fixed_size<8>, simd_device_tag>;
  using value_type = bool;
...
struct simd_mask_native_ops<std::int64_t, simd_abi::avx2_fixed_size<4>, simd_device_tag> {
  using vector_type = simd_vector_t<std::int64_t, simd_abi::avx2_fixed_size<4>, simd_device_tag>;
  using value_type = bool;
...
struct simd_mask_native_ops<std::uint64_t, simd_abi::avx2_fixed_size<4>, simd_device_tag> {
  using vector_type = simd_vector_t<std::uint64_t, simd_abi::avx2_fixed_size<4>, simd_device_tag>;
  using value_type = bool;
...
struct simd_mask_native_ops<float, simd_abi::avx2_fixed_size<4>, simd_host_tag> {
  using vector_type = simd_vector_t<float, simd_abi::avx2_fixed_size<4>, simd_host_tag>;
  using value_type = bool;

  KOKKOS_SIMD_IMPL_NATIVE_FN_HOST(vector_type, set1, value_type, _mm_castsi128_ps(_mm_set1_epi32(-std::int32_t(v))))

  KOKKOS_SIMD_IMPL_NATIVE_GEN_FN_HOST(vector_type, gen, _mm_castsi128_ps(_mm_setr_epi32(
  ...
  KOKKOS_SIMD_IMPL_NATIVE_UNARY_OP_HOST(vector_type, lnot, _mm_andnot_ps(v, set1(true)))
  KOKKOS_SIMD_IMPL_NATIVE_UNARY_OP_HOST(vector_type, bnot, lnot(v);)

  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, land, band(lhs, rhs))
  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, lor, bor(lhs, rhs))
  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, band, _mm_and_ps(lhs, rhs))
  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, bor, _mm_or_ps(lhs, rhs))
  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, bxor, _mm_xor_ps(lhs, rhs))

  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(value_type, eq, (_mm_movemask_ps(lhs) == _mm_movemask_ps(rhs)))
  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(value_type, neq, !eq(lhs, rhs))
};

template <>
struct simd_mask_native_ops<float, simd_abi::avx2_fixed_size<8>, simd_host_tag> {
  using vector_type = simd_vector_t<float, simd_abi::avx2_fixed_size<8>, simd_host_tag>;
  using value_type = bool;

  KOKKOS_SIMD_IMPL_NATIVE_FN_HOST(vector_type, set1, value_type, _mm256_castsi256_ps(_mm256_set1_epi32(-std::int32_t(v))))

  KOKKOS_SIMD_IMPL_NATIVE_GEN_FN_HOST(vector_type, gen, _mm256_castsi256_ps(_mm256_setr_epi32(
                                                          -std::int32_t(v(std::integral_constant<simd_size_t, 0>())),
                                                          -std::int32_t(v(std::integral_constant<simd_size_t, 1>())),
                                                          -std::int32_t(v(std::integral_constant<simd_size_t, 2>())),
                                                          -std::int32_t(v(std::integral_constant<simd_size_t, 3>())),
  ...
  KOKKOS_SIMD_IMPL_NATIVE_UNARY_OP_HOST(vector_type, lnot, _mm256_andnot_ps(v, set1(true)))
  KOKKOS_SIMD_IMPL_NATIVE_UNARY_OP_HOST(vector_type, bnot, lnot(v);)

  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, land, band(lhs, rhs))
  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, lor, bor(lhs, rhs))
  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, band, _mm256_and_ps(lhs, rhs))
  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, bor, _mm256_or_ps(lhs, rhs))
  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, bxor, _mm256_xor_ps(lhs, rhs))

  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(value_type, eq, (_mm256_movemask_ps(lhs) == _mm256_movemask_ps(rhs)))
  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(value_type, neq, !eq(lhs, rhs))
};

template <>
struct simd_mask_native_ops<std::int32_t, simd_abi::avx2_fixed_size<4>, simd_host_tag> {
  using vector_type = simd_vector_t<std::int32_t, simd_abi::avx2_fixed_size<4>, simd_host_tag>;
  using value_type = bool;

  KOKKOS_SIMD_IMPL_NATIVE_FN_HOST(vector_type, set1, value_type, _mm_set1_epi32(-std::int32_t(v)))

  KOKKOS_SIMD_IMPL_NATIVE_GEN_FN_HOST(vector_type, gen, _mm_setr_epi32(
                                                          -std::int32_t(v(std::integral_constant<simd_size_t, 0>())),
                                                          -std::int32_t(v(std::integral_constant<simd_size_t, 1>())),
                                                          -std::int32_t(v(std::integral_constant<simd_size_t, 2>())),
                                                          -std::int32_t(v(std::integral_constant<simd_size_t, 3>()))))
  ...
  KOKKOS_SIMD_IMPL_NATIVE_UNARY_OP_HOST(vector_type, lnot, _mm_andnot_si128(v, set1(true)))
  KOKKOS_SIMD_IMPL_NATIVE_UNARY_OP_HOST(vector_type, bnot, lnot(v);)

  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, land, band(lhs, rhs))
  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, lor, bor(lhs, rhs))
  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, band, _mm_and_si128(lhs, rhs))
  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, bor, _mm_or_si128(lhs, rhs))
  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, bxor, _mm_xor_si128(lhs, rhs))

  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(value_type, eq, (_mm_movemask_ps(_mm_castsi128_ps(lhs)) ==
...
struct simd_mask_native_ops<std::int32_t, simd_abi::avx2_fixed_size<8>, simd_host_tag> {
  using vector_type = simd_vector_t<std::int32_t, simd_abi::avx2_fixed_size<8>, simd_host_tag>;
  using value_type = bool;

  KOKKOS_SIMD_IMPL_NATIVE_FN_HOST(vector_type, set1, value_type, _mm256_set1_epi32(-std::int32_t(v)))

  KOKKOS_SIMD_IMPL_NATIVE_GEN_FN_HOST(vector_type, gen, _mm256_setr_epi32(
                                                          -std::int32_t(v(std::integral_constant<simd_size_t, 0>())),
                                                          -std::int32_t(v(std::integral_constant<simd_size_t, 1>())),
                                                          -std::int32_t(v(std::integral_constant<simd_size_t, 2>())),
                                                          -std::int32_t(v(std::integral_constant<simd_size_t, 3>())),
  ...
  KOKKOS_SIMD_IMPL_NATIVE_UNARY_OP_HOST(vector_type, lnot, _mm256_andnot_si256(v, set1(true)))
  KOKKOS_SIMD_IMPL_NATIVE_UNARY_OP_HOST(vector_type, bnot, lnot(v);)

  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, land, band(lhs, rhs))
  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, lor, bor(lhs, rhs))
  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, band, _mm256_and_si256(lhs, rhs))
  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, bor, _mm256_or_si256(lhs, rhs))
  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, bxor, _mm256_xor_si256(lhs, rhs))

  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(value_type, eq, (_mm256_movemask_ps(_mm256_castsi256_ps(lhs)) == _mm256_movemask_ps(_mm256_castsi256_ps(rhs))))
  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(value_type, neq, !eq(lhs, rhs))
};

template <>
struct simd_mask_native_ops<std::int64_t, simd_abi::avx2_fixed_size<4>, simd_host_tag> {
  using vector_type = simd_vector_t<std::int64_t, simd_abi::avx2_fixed_size<4>, simd_host_tag>;
  using value_type = bool;

  KOKKOS_SIMD_IMPL_NATIVE_FN_HOST(vector_type, set1, value_type, _mm256_set1_epi64x(-std::int64_t(v)))

  KOKKOS_SIMD_IMPL_NATIVE_GEN_FN_HOST(vector_type, gen, _mm256_setr_epi64x(
                                                          -std::int64_t(v(std::integral_constant<simd_size_t, 0>())),
                                                          -std::int64_t(v(std::integral_constant<simd_size_t, 1>())),
                                                          -std::int64_t(v(std::integral_constant<simd_size_t, 2>())),
                                                          -std::int64_t(v(std::integral_constant<simd_size_t, 3>()))))
...
struct simd_mask_native_ops<std::uint64_t, simd_abi::avx2_fixed_size<4>, simd_host_tag> {
  using vector_type = simd_vector_t<std::uint64_t, simd_abi::avx2_fixed_size<4>, simd_host_tag>;
  using value_type = bool;
...
struct simd_native_ops<std::int32_t, simd_abi::avx2_fixed_size<4>, simd_device_tag> {
  ...
  KOKKOS_SIMD_IMPL_NATIVE_UNARY_OP_DEVICE(vector_type, neg, vector_type{})
  KOKKOS_SIMD_IMPL_NATIVE_UNARY_OP_DEVICE(vector_type, bnot, vector_type{})
  ...
  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_DEVICE(vector_type, sll, vector_type{})
  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_DEVICE(vector_type, sra, vector_type{})
  KOKKOS_SIMD_IMPL_NATIVE_SHIFT_SCALAR_DEVICE(vector_type, sll, vector_type{})
  KOKKOS_SIMD_IMPL_NATIVE_SHIFT_SCALAR_DEVICE(vector_type, sra, vector_type{})
  ...
  using rounded_type = simd_vector_t<double, simd_abi::avx2_fixed_size<4>, simd_device_tag>;
  KOKKOS_SIMD_IMPL_NATIVE_UNARY_MATH_OP_DEVICE(rounded_type, floor, rounded_type{})
  KOKKOS_SIMD_IMPL_NATIVE_UNARY_MATH_OP_DEVICE(rounded_type, ceil, rounded_type{})
  KOKKOS_SIMD_IMPL_NATIVE_UNARY_MATH_OP_DEVICE(rounded_type, round, rounded_type{})
  KOKKOS_SIMD_IMPL_NATIVE_UNARY_MATH_OP_DEVICE(rounded_type, trunc, rounded_type{})
...
struct simd_native_ops<std::int32_t, simd_abi::avx2_fixed_size<8>, simd_device_tag> {
  ...
  using rounded_type = simd_vector_t<float, simd_abi::avx2_fixed_size<8>, simd_device_tag>;
  KOKKOS_SIMD_IMPL_NATIVE_UNARY_MATH_OP_DEVICE(rounded_type, floor, rounded_type{})
  KOKKOS_SIMD_IMPL_NATIVE_UNARY_MATH_OP_DEVICE(rounded_type, ceil, rounded_type{})
  KOKKOS_SIMD_IMPL_NATIVE_UNARY_MATH_OP_DEVICE(rounded_type, round, rounded_type{})
  KOKKOS_SIMD_IMPL_NATIVE_UNARY_MATH_OP_DEVICE(rounded_type, trunc, rounded_type{})
...
struct simd_native_ops<float, simd_abi::avx2_fixed_size<4>, simd_host_tag> {
  ...
  KOKKOS_SIMD_IMPL_NATIVE_GEN_FN_HOST(vector_type, set1, _mm_set1_ps(value_type(v)))

  KOKKOS_SIMD_IMPL_NATIVE_GEN_FN_HOST(vector_type, gen, _mm_setr_ps(v(std::integral_constant<Impl::simd_size_t, 0>()),
                                                          v(std::integral_constant<Impl::simd_size_t, 1>()),
                                                          v(std::integral_constant<Impl::simd_size_t, 2>()),
                                                          v(std::integral_constant<Impl::simd_size_t, 3>())))

  KOKKOS_SIMD_IMPL_NATIVE_LOAD_HOST(vector_type, load, const value_type*, 
    if constexpr (std::is_same_v<simd_flags<Flags...>,
                                 simd_flags<simd_alignment_vector_aligned>>) {
  ...
  KOKKOS_SIMD_IMPL_NATIVE_MASKED_LOAD_HOST(vector_type, masked_load, const value_type*, vector_type, return _mm_maskload_ps(ptr, _mm_castps_si128(mask));)
  ...
  KOKKOS_SIMD_IMPL_NATIVE_UNARY_OP_HOST(vector_type, neg, _mm_sub_ps(_mm_set1_ps(0.0), v))

  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, plus, _mm_add_ps(lhs, rhs))
  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, minus, _mm_sub_ps(lhs, rhs))
  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, multiply, _mm_mul_ps(lhs, rhs))
  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, divide, _mm_div_ps(lhs, rhs))
  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, eq, _mm_cmpeq_ps(lhs, rhs))
  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, neq, _mm_cmpneq_ps(lhs, rhs))
  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, ge, _mm_cmpge_ps(lhs, rhs))
  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, le, _mm_cmple_ps(lhs, rhs))
  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, gt, _mm_cmpgt_ps(lhs, rhs))
  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, lt, _mm_cmplt_ps(lhs, rhs))
  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, copysign, _mm_xor_ps(_mm_andnot_ps(_mm_set1_ps(-0.0), static_cast<vector_type>(lhs)),
                 _mm_and_ps(_mm_set1_ps(-0.0), static_cast<vector_type>(rhs))))

  KOKKOS_SIMD_IMPL_NATIVE_UNARY_MATH_OP_HOST(vector_type, abs, _mm_andnot_ps(_mm_set1_ps(-0.0), static_cast<vector_type>(v)))
  KOKKOS_SIMD_IMPL_NATIVE_UNARY_MATH_OP_HOST(vector_type, floor, _mm_round_ps(static_cast<vector_type>(v),
                                                                (_MM_FROUND_TO_NEG_INF | _MM_FROUND_NO_EXC)))
  KOKKOS_SIMD_IMPL_NATIVE_UNARY_MATH_OP_HOST(vector_type, ceil, _mm_round_ps(static_cast<vector_type>(v),
                                                                (_MM_FROUND_TO_POS_INF | _MM_FROUND_NO_EXC)))
  KOKKOS_SIMD_IMPL_NATIVE_UNARY_MATH_OP_HOST(vector_type, round, _mm_round_ps(static_cast<vector_type>(v),
                                                                (_MM_FROUND_TO_NEAREST_INT | _MM_FROUND_NO_EXC)))
  KOKKOS_SIMD_IMPL_NATIVE_UNARY_MATH_OP_HOST(vector_type, trunc, _mm_round_ps(static_cast<vector_type>(v),
                                                                (_MM_FROUND_TO_ZERO | _MM_FROUND_NO_EXC)))
  KOKKOS_SIMD_IMPL_NATIVE_UNARY_MATH_OP_HOST(vector_type, sqrt, _mm_sqrt_ps(static_cast<vector_type>(v)))

#ifdef KOKKOS_HAVE_INTEL_SVML
  KOKKOS_SIMD_IMPL_NATIVE_UNARY_MATH_OP_HOST(vector_type, cbrt, _mm_cbrt_ps(static_cast<vector_type>(v)))
  KOKKOS_SIMD_IMPL_NATIVE_UNARY_MATH_OP_HOST(vector_type, exp, _mm_exp_ps(static_cast<vector_type>(v)))
  KOKKOS_SIMD_IMPL_NATIVE_UNARY_MATH_OP_HOST(vector_type, log, _mm_log_ps(static_cast<vector_type>(v)))
#endif

  KOKKOS_SIMD_IMPL_NATIVE_TERNARY_MATH_OP_HOST(vector_type, fma, _mm_fmadd_ps(static_cast<vector_type>(a), static_cast<vector_type>(b),
                                                                                 static_cast<vector_type>(c)))

  KOKKOS_SIMD_IMPL_NATIVE_BINARY_MATH_OP_HOST(vector_type, max, _mm_max_ps(static_cast<vector_type>(lhs), static_cast<vector_type>(rhs)))
  KOKKOS_SIMD_IMPL_NATIVE_BINARY_MATH_OP_HOST(vector_type, min, _mm_min_ps(static_cast<vector_type>(lhs), static_cast<vector_type>(rhs)))
...
struct simd_native_ops<float, simd_abi::avx2_fixed_size<8>, simd_host_tag> {
  ...
  KOKKOS_SIMD_IMPL_NATIVE_GEN_FN_HOST(vector_type, set1, _mm256_set1_ps(value_type(v)))

  KOKKOS_SIMD_IMPL_NATIVE_GEN_FN_HOST(vector_type, gen, _mm256_setr_ps(
                                                          v(std::integral_constant<Impl::simd_size_t, 0>()),
                                                          v(std::integral_constant<Impl::simd_size_t, 1>()),
                                                          v(std::integral_constant<Impl::simd_size_t, 2>()),
                                                          v(std::integral_constant<Impl::simd_size_t, 3>()),
                                                          v(std::integral_constant<Impl::simd_size_t, 4>()),
                                                          v(std::integral_constant<Impl::simd_size_t, 5>()),
                                                          v(std::integral_constant<Impl::simd_size_t, 6>()),
                                                          v(std::integral_constant<Impl::simd_size_t, 7>())))
  ...
  KOKKOS_SIMD_IMPL_NATIVE_MASKED_LOAD_HOST(vector_type, masked_load, const value_type*, vector_type, return _mm256_maskload_ps(ptr, _mm256_castps_si256(mask));)
  ...
  KOKKOS_SIMD_IMPL_NATIVE_UNARY_OP_HOST(vector_type, neg, _mm256_sub_ps(_mm256_set1_ps(0.0), v))

  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, plus, _mm256_add_ps(lhs, rhs))
  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, minus, _mm256_sub_ps(lhs, rhs))
  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, multiply, _mm256_mul_ps(lhs, rhs))
  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, divide, _mm256_div_ps(lhs, rhs))
  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, eq, _mm256_cmp_ps(lhs, rhs, _CMP_EQ_OS))
  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, neq, _mm256_cmp_ps(lhs, rhs, _CMP_NEQ_OS))
  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, ge, _mm256_cmp_ps(lhs, rhs, _CMP_GE_OS))
  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, le, _mm256_cmp_ps(lhs, rhs, _CMP_LE_OS))
  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, gt, _mm256_cmp_ps(lhs, rhs, _CMP_GT_OS))
  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, lt, _mm256_cmp_ps(lhs, rhs, _CMP_LT_OS))
  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, copysign, _mm256_xor_ps(_mm256_andnot_ps(_mm256_set1_ps(-0.0), static_cast<vector_type>(lhs)),
                    _mm256_and_ps(_mm256_set1_ps(-0.0), static_cast<vector_type>(rhs))))

  KOKKOS_SIMD_IMPL_NATIVE_UNARY_MATH_OP_HOST(vector_type, abs, _mm256_andnot_ps(_mm256_set1_ps(-0.0), static_cast<vector_type>(v)))
  KOKKOS_SIMD_IMPL_NATIVE_UNARY_MATH_OP_HOST(vector_type, floor,_mm256_round_ps(static_cast<vector_type>(v),
                                                                  (_MM_FROUND_TO_NEG_INF | _MM_FROUND_NO_EXC)))
  KOKKOS_SIMD_IMPL_NATIVE_UNARY_MATH_OP_HOST(vector_type, ceil, _mm256_round_ps(static_cast<vector_type>(v),
                                                                  (_MM_FROUND_TO_POS_INF | _MM_FROUND_NO_EXC)))
  KOKKOS_SIMD_IMPL_NATIVE_UNARY_MATH_OP_HOST(vector_type, round, _mm256_round_ps(static_cast<vector_type>(v),
                                                                  (_MM_FROUND_TO_NEAREST_INT | _MM_FROUND_NO_EXC)))
  KOKKOS_SIMD_IMPL_NATIVE_UNARY_MATH_OP_HOST(vector_type, trunc, _mm256_round_ps(static_cast<vector_type>(v),
                                                                  (_MM_FROUND_TO_ZERO | _MM_FROUND_NO_EXC)))
  KOKKOS_SIMD_IMPL_NATIVE_UNARY_MATH_OP_HOST(vector_type, sqrt, _mm256_sqrt_ps(static_cast<vector_type>(v)))

#ifdef KOKKOS_HAVE_INTEL_SVML
  KOKKOS_SIMD_IMPL_NATIVE_UNARY_MATH_OP_HOST(vector_type, cbrt, _mm256_cbrt_ps(static_cast<vector_type>(v)))
  KOKKOS_SIMD_IMPL_NATIVE_UNARY_MATH_OP_HOST(vector_type, exp, _mm256_exp_ps(static_cast<vector_type>(v)))
  KOKKOS_SIMD_IMPL_NATIVE_UNARY_MATH_OP_HOST(vector_type, log, _mm256_log_ps(static_cast<vector_type>(v)))
#endif

  KOKKOS_SIMD_IMPL_NATIVE_TERNARY_MATH_OP_HOST(vector_type, fma, _mm256_fmadd_ps(static_cast<vector_type>(a), static_cast<vector_type>(b),
                                                                                 static_cast<vector_type>(c)))

  KOKKOS_SIMD_IMPL_NATIVE_BINARY_MATH_OP_HOST(vector_type, max, _mm256_max_ps(static_cast<vector_type>(lhs), static_cast<vector_type>(rhs)))
  KOKKOS_SIMD_IMPL_NATIVE_BINARY_MATH_OP_HOST(vector_type, min, _mm256_min_ps(static_cast<vector_type>(lhs), static_cast<vector_type>(rhs)))
...
struct simd_native_ops<std::int32_t, simd_abi::avx2_fixed_size<4>, simd_host_tag> {
  ...
  KOKKOS_SIMD_IMPL_NATIVE_GEN_FN_HOST(vector_type, set1, _mm_set1_epi32(value_type(v)))
  ...
  KOKKOS_SIMD_IMPL_NATIVE_MASKED_LOAD_HOST(vector_type, masked_load, const value_type*, vector_type, return _mm_maskload_epi32(ptr, mask);)
...
// missing return statement warning with cuda >= 12.9
  ...
  KOKKOS_SIMD_IMPL_NATIVE_UNARY_OP_HOST(vector_type, neg, minus(set1(0), v))
  KOKKOS_SIMD_IMPL_NATIVE_UNARY_OP_HOST(vector_type, bnot, _mm_andnot_si128(v, set1(~value_type(0))))

  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, plus, _mm_add_epi32(lhs, rhs))
  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, minus, _mm_sub_epi32(lhs, rhs))
  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, multiply, _mm_mullo_epi32(lhs, rhs))
  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, band, _mm_and_si128(lhs, rhs))
  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, bor, _mm_or_si128(lhs, rhs))
  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, bxor, _mm_xor_si128(lhs, rhs))

  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, sll, _mm_sllv_epi32(lhs, rhs))
  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, sra, _mm_srav_epi32(lhs, rhs))
  KOKKOS_SIMD_IMPL_NATIVE_SHIFT_SCALAR_HOST(vector_type, sll, _mm_slli_epi32(lhs, rhs))
  KOKKOS_SIMD_IMPL_NATIVE_SHIFT_SCALAR_HOST(vector_type, sra, _mm_srai_epi32(lhs, rhs))

  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, eq, _mm_cmpeq_epi32(lhs, rhs))
  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, neq, bnot(eq(lhs, rhs)))
  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, gt, _mm_cmpgt_epi32(lhs, rhs))
  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, lt, _mm_cmplt_epi32(lhs, rhs))
  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, ge, bor(gt(lhs, rhs), eq(lhs, rhs)))
  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, le, bor(lt(lhs, rhs), eq(lhs, rhs)))
  // KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, copysign, _mm256_xor_ps(_mm256_andnot_ps(_mm256_set1_ps(-0.0), static_cast<vector_type>(lhs)),
  //                   _mm256_and_ps(_mm256_set1_ps(-0.0), static_cast<vector_type>(rhs))))

  KOKKOS_SIMD_IMPL_NATIVE_UNARY_MATH_OP_HOST(vector_type, abs, _mm_abs_epi32(v))

  using rounded_type = simd_vector_t<double, simd_abi::avx2_fixed_size<4>, simd_host_tag>;
  KOKKOS_SIMD_IMPL_NATIVE_UNARY_MATH_OP_HOST(rounded_type, floor, _mm256_cvtepi32_pd(v))
  KOKKOS_SIMD_IMPL_NATIVE_UNARY_MATH_OP_HOST(rounded_type, ceil, _mm256_cvtepi32_pd(v))
  KOKKOS_SIMD_IMPL_NATIVE_UNARY_MATH_OP_HOST(rounded_type, round, _mm256_cvtepi32_pd(v))
  KOKKOS_SIMD_IMPL_NATIVE_UNARY_MATH_OP_HOST(rounded_type, trunc, _mm256_cvtepi32_pd(v))

  KOKKOS_SIMD_IMPL_NATIVE_BINARY_MATH_OP_HOST(vector_type, max, _mm_max_epi32(static_cast<vector_type>(lhs), static_cast<vector_type>(rhs)))
  KOKKOS_SIMD_IMPL_NATIVE_BINARY_MATH_OP_HOST(vector_type, min, _mm_min_epi32(static_cast<vector_type>(lhs), static_cast<vector_type>(rhs)))

  KOKKOS_SIMD_IMPL_NATIVE_TERNARY_MATH_OP_HOST(vector_type, condition, _mm_castps_si128(
...
struct simd_native_ops<std::int32_t, simd_abi::avx2_fixed_size<8>, simd_host_tag> {
  ...
  KOKKOS_SIMD_IMPL_NATIVE_GEN_FN_HOST(vector_type, set1, _mm256_set1_epi32(value_type(v)))
  ...
  KOKKOS_SIMD_IMPL_NATIVE_MASKED_LOAD_HOST(vector_type, masked_load, const value_type*, vector_type, return _mm256_maskload_epi32(ptr, mask);)
...
// _mm256_cvtsi256_si32 was not added in GCC until 11
  ...
  KOKKOS_SIMD_IMPL_NATIVE_UNARY_OP_HOST(vector_type, neg, minus(set1(0), v))
  KOKKOS_SIMD_IMPL_NATIVE_UNARY_OP_HOST(vector_type, bnot, _mm256_andnot_si256(v, set1(~value_type(0))))

  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, plus, _mm256_add_epi32(lhs, rhs))
  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, minus, _mm256_sub_epi32(lhs, rhs))
  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, multiply, _mm256_mullo_epi32(lhs, rhs))
  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, band, _mm256_and_si256(lhs, rhs))
  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, bor, _mm256_or_si256(lhs, rhs))
  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, bxor, _mm256_xor_si256(lhs, rhs))

  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, sll, _mm256_sllv_epi32(lhs, rhs))
  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, sra, _mm256_srav_epi32(lhs, rhs))
  KOKKOS_SIMD_IMPL_NATIVE_SHIFT_SCALAR_HOST(vector_type, sll, _mm256_slli_epi32(lhs, rhs))
  KOKKOS_SIMD_IMPL_NATIVE_SHIFT_SCALAR_HOST(vector_type, sra, _mm256_srai_epi32(lhs, rhs))

  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, eq, _mm256_cmpeq_epi32(lhs, rhs))
  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, neq, bnot(eq(lhs, rhs)))
  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, gt, _mm256_cmpgt_epi32(lhs, rhs))
  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, ge, bor(gt(lhs, rhs), eq(lhs, rhs)))
  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, lt, bnot(ge(lhs, rhs)))
  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, le, bor(lt(lhs, rhs), eq(lhs, rhs)))
  // KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, copysign, _mm256_xor_ps(_mm256_andnot_ps(_mm256_set1_ps(-0.0), static_cast<vector_type>(a)),
  //                   _mm256_and_ps(_mm256_set1_ps(-0.0), static_cast<vector_type>(b))))

  KOKKOS_SIMD_IMPL_NATIVE_UNARY_MATH_OP_HOST(vector_type, abs, _mm256_abs_epi32(v))

  using rounded_type = simd_vector_t<float, simd_abi::avx2_fixed_size<8>, simd_host_tag>;
  KOKKOS_SIMD_IMPL_NATIVE_UNARY_MATH_OP_HOST(rounded_type, floor, _mm256_cvtepi32_ps(v))
  KOKKOS_SIMD_IMPL_NATIVE_UNARY_MATH_OP_HOST(rounded_type, ceil, _mm256_cvtepi32_ps(v))
  KOKKOS_SIMD_IMPL_NATIVE_UNARY_MATH_OP_HOST(rounded_type, round, _mm256_cvtepi32_ps(v))
  KOKKOS_SIMD_IMPL_NATIVE_UNARY_MATH_OP_HOST(rounded_type, trunc, _mm256_cvtepi32_ps(v))

  KOKKOS_SIMD_IMPL_NATIVE_BINARY_MATH_OP_HOST(vector_type, max, _mm256_max_epi32(static_cast<vector_type>(lhs), static_cast<vector_type>(rhs)))
  KOKKOS_SIMD_IMPL_NATIVE_BINARY_MATH_OP_HOST(vector_type, min, _mm256_min_epi32(static_cast<vector_type>(lhs), static_cast<vector_type>(rhs)))

  KOKKOS_SIMD_IMPL_NATIVE_TERNARY_MATH_OP_HOST(vector_type, condition, _mm256_castps_si256(
...
struct simd_native_ops<std::int64_t, simd_abi::avx2_fixed_size<4>, simd_host_tag> {
  ...
  KOKKOS_SIMD_IMPL_NATIVE_GEN_FN_HOST(vector_type, set1, _mm256_set1_epi64x(value_type(v)))
  ...
  KOKKOS_SIMD_IMPL_NATIVE_MASKED_LOAD_HOST(vector_type, masked_load, const value_type*, vector_type, return _mm256_maskload_epi64(reinterpret_cast<long long const*>(ptr), mask);)
  ...
  KOKKOS_SIMD_IMPL_NATIVE_UNARY_OP_HOST(vector_type, neg, _mm256_sub_epi64(set1(0), v))
  KOKKOS_SIMD_IMPL_NATIVE_UNARY_OP_HOST(vector_type, bnot, _mm256_andnot_si256(v, set1(~value_type(0))))

  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, plus, _mm256_add_epi64(lhs, rhs))
  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, minus, _mm256_sub_epi64(lhs, rhs))
  ...
  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, multiply, gen([&](simd_size_t i) { return extract(lhs, i) * extract(rhs, i); }))

  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, band, _mm256_and_si256(lhs, rhs))
  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, bor, _mm256_or_si256(lhs, rhs))
  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, bxor, _mm256_xor_si256(lhs, rhs))

  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, sll, _mm256_sllv_epi64(lhs, rhs))
  ...
  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, sra, gen([&](simd_size_t i) { return extract(lhs, i) >> extract(rhs, i); }))
  KOKKOS_SIMD_IMPL_NATIVE_SHIFT_SCALAR_HOST(vector_type, sll, _mm256_slli_epi64(lhs, rhs))
  ...
  KOKKOS_SIMD_IMPL_NATIVE_UNARY_MATH_OP_HOST(vector_type, abs, 
    gen([&](simd_size_t i) {
      auto a = extract(v, i);
      return (a < 0) ? -a : a;
    })
  ...
  using rounded_type = simd_vector_t<double, simd_abi::avx2_fixed_size<4>, simd_host_tag>;
  KOKKOS_SIMD_IMPL_NATIVE_UNARY_MATH_OP_HOST(rounded_type, floor, _mm256_setr_pd(extract(v,0),extract(v,1),extract(v,2),extract(v,3)))
  KOKKOS_SIMD_IMPL_NATIVE_UNARY_MATH_OP_HOST(rounded_type, ceil, _mm256_setr_pd(extract(v,0),extract(v,1),extract(v,2),extract(v,3)))
  KOKKOS_SIMD_IMPL_NATIVE_UNARY_MATH_OP_HOST(rounded_type, round, _mm256_setr_pd(extract(v,0),extract(v,1),extract(v,2),extract(v,3)))
  KOKKOS_SIMD_IMPL_NATIVE_UNARY_MATH_OP_HOST(rounded_type, trunc, _mm256_setr_pd(extract(v,0),extract(v,1),extract(v,2),extract(v,3)))

  KOKKOS_SIMD_IMPL_NATIVE_BINARY_MATH_OP_HOST(vector_type, max, _mm256_blendv_epi8(static_cast<vector_type>(lhs), static_cast<vector_type>(rhs), gt(rhs, lhs)))
  KOKKOS_SIMD_IMPL_NATIVE_BINARY_MATH_OP_HOST(vector_type, min, _mm256_blendv_epi8(static_cast<vector_type>(lhs), static_cast<vector_type>(rhs), lt(rhs, lhs)))

  KOKKOS_SIMD_IMPL_NATIVE_TERNARY_MATH_OP_HOST(vector_type, condition, _mm256_castpd_si256(
...
struct simd_native_ops<std::uint64_t, simd_abi::avx2_fixed_size<4>, simd_host_tag> {
  ...
  KOKKOS_SIMD_IMPL_NATIVE_GEN_FN_HOST(vector_type, set1, _mm256_set1_epi64x(Kokkos::bit_cast<std::int64_t>(value_type(v))))
  ...
  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, sll, _mm256_sllv_epi64(lhs, rhs))
  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, sra, _mm256_srlv_epi64(lhs, rhs))
  KOKKOS_SIMD_IMPL_NATIVE_SHIFT_SCALAR_HOST(vector_type, sll, _mm256_slli_epi64(lhs, rhs))
  KOKKOS_SIMD_IMPL_NATIVE_SHIFT_SCALAR_HOST(vector_type, sra, _mm256_srli_epi64(lhs, rhs))

  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, eq, _mm256_cmpeq_epi64(lhs, rhs))
  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, neq, bxor(eq(lhs, rhs), set1(-1));)

  using signed_t = simd_native_ops<std::int64_t, simd_abi::avx2_fixed_size<4>, simd_host_tag>;
  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, gt, 
  ...
  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, lt, gt(rhs, lhs))
  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, ge, bnot(lt(lhs, rhs)))
  KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, le, bnot(gt(lhs, rhs)))
  // KOKKOS_SIMD_IMPL_NATIVE_BINARY_OP_HOST(vector_type, copysign, _mm256_xor_ps(_mm256_andnot_ps(_mm256_set1_ps(-0.0), static_cast<vector_type>(a)),
  //                   _mm256_and_ps(_mm256_set1_ps(-0.0), static_cast<vector_type>(b))))

  KOKKOS_SIMD_IMPL_NATIVE_UNARY_MATH_OP_HOST(vector_type, abs, v)
