...
KOKKOS_SIMD_IMPL_DEFINE_MATH_FN(double, Experimental::simd_abi::avx2_fixed_size<4>)
KOKKOS_SIMD_IMPL_DEFINE_MATH_FN(float, Experimental::simd_abi::avx2_fixed_size<4>)
KOKKOS_SIMD_IMPL_DEFINE_MATH_FN(float, Experimental::simd_abi::avx2_fixed_size<8>)
KOKKOS_SIMD_IMPL_DEFINE_MATH_FN(std::int32_t, Experimental::simd_abi::avx2_fixed_size<4>)
KOKKOS_SIMD_IMPL_DEFINE_MATH_FN(std::int32_t, Experimental::simd_abi::avx2_fixed_size<8>)
KOKKOS_SIMD_IMPL_DEFINE_MATH_FN(std::int64_t, Experimental::simd_abi::avx2_fixed_size<4>)
KOKKOS_SIMD_IMPL_DEFINE_MATH_FN(std::uint64_t, Experimental::simd_abi::avx2_fixed_size<4>)
...
KOKKOS_SIMD_IMPL_DEFINE_LOAD_STORE_FN_AVX2(std::int32_t, simd_abi::avx2_fixed_size<4>)
KOKKOS_SIMD_IMPL_DEFINE_LOAD_STORE_FN_AVX2(std::int32_t, simd_abi::avx2_fixed_size<8>)
KOKKOS_SIMD_IMPL_DEFINE_LOAD_STORE_FN_AVX2(std::int64_t, simd_abi::avx2_fixed_size<4>)
KOKKOS_SIMD_IMPL_DEFINE_LOAD_STORE_FN_AVX2(std::uint64_t, simd_abi::avx2_fixed_size<4>)

KOKKOS_SIMD_IMPL_DEFINE_MASKED_FN_AVX2(condition)

KOKKOS_SIMD_IMPL_DEFINE_MEMORY_PERMUTE_FN_AVX2(double, double, simd_abi::avx2_fixed_size<4>)
KOKKOS_SIMD_IMPL_DEFINE_MEMORY_PERMUTE_FN_AVX2(float, float, simd_abi::avx2_fixed_size<4>)
KOKKOS_SIMD_IMPL_DEFINE_MEMORY_PERMUTE_FN_AVX2(float, float, simd_abi::avx2_fixed_size<8>)
KOKKOS_SIMD_IMPL_DEFINE_MEMORY_PERMUTE_FN_AVX2(std::int32_t, std::int32_t, simd_abi::avx2_fixed_size<4>)
KOKKOS_SIMD_IMPL_DEFINE_MEMORY_PERMUTE_FN_AVX2(std::int32_t, std::int32_t, simd_abi::avx2_fixed_size<8>)
KOKKOS_SIMD_IMPL_DEFINE_MEMORY_PERMUTE_FN_AVX2(std::int64_t, std::int64_t, simd_abi::avx2_fixed_size<4>)
KOKKOS_SIMD_IMPL_DEFINE_MEMORY_PERMUTE_FN_AVX2(std::uint64_t, std::int64_t, simd_abi::avx2_fixed_size<4>)
