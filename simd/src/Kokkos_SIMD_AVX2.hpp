...
class basic_simd_mask<T, simd_abi::avx2_fixed_size<N>> :
 ...
 private:
  ...
  using impl_ops =
      Impl::simd_mask_native_ops<T, abi_type, Impl::simd_backend_t>;
 ...
 public:
  static constexpr Kokkos::Impl::integral_constant<Impl::simd_size_t, N> size{};
...
template <typename T, Impl::simd_size_t N>
  requires Impl::IsValidSimdType<T, simd_abi::avx2_fixed_size<N>>
class basic_simd<T, simd_abi::avx2_fixed_size<N>>
    : public Impl::basic_simd_base<
          basic_simd<T, simd_abi::avx2_fixed_size<N>>> {
 public:
  using value_type = T;
  using abi_type   = simd_abi::avx2_fixed_size<N>;
 ...
 private:
  ...
  using impl_ops = Impl::simd_native_ops<T, simd_abi::avx2_fixed_size<N>,
                                         Impl::simd_backend_t>;
  using impl_vector_type      = typename impl_ops::vector_type;
  using impl_host_vector_type = typename impl_ops::host_vector_type;
