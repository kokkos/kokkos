...
DESUL_INLINE_FUNCTION T device_atomic_fetch_add(T* const dest,
                                                ...
                                                MemoryOrder order,
                                                MemoryScope scope) {
  return device_atomic_fetch_oper(AddOper<T, const T>(), dest, val, order, scope);
}
...
DESUL_INLINE_FUNCTION T device_atomic_fetch_sub(T* const dest,
                                                ...
                                                MemoryOrder order,
                                                MemoryScope scope) {
  return device_atomic_fetch_oper(SubOper<T, const T>(), dest, val, order, scope);
}
...
DESUL_INLINE_FUNCTION T device_atomic_fetch_max(T* const dest,
                                                ...
                                                MemoryOrder order,
                                                MemoryScope scope) {
  return device_atomic_fetch_oper(MaxOper<T, const T>(), dest, val, order, scope);
}
...
DESUL_INLINE_FUNCTION T device_atomic_fetch_min(T* const dest,
                                                ...
                                                MemoryOrder order,
                                                MemoryScope scope) {
  return device_atomic_fetch_oper(MinOper<T, const T>(), dest, val, order, scope);
}
...
DESUL_INLINE_FUNCTION T device_atomic_fetch_mul(T* const dest,
                                                ...
                                                MemoryOrder order,
                                                MemoryScope scope) {
  return device_atomic_fetch_oper(MulOper<T, const T>(), dest, val, order, scope);
}
...
DESUL_INLINE_FUNCTION T device_atomic_fetch_div(T* const dest,
                                                ...
                                                MemoryOrder order,
                                                MemoryScope scope) {
  return device_atomic_fetch_oper(DivOper<T, const T>(), dest, val, order, scope);
}
...
DESUL_INLINE_FUNCTION T device_atomic_fetch_mod(T* const dest,
                                                ...
                                                MemoryOrder order,
                                                MemoryScope scope) {
  return device_atomic_fetch_oper(ModOper<T, const T>(), dest, val, order, scope);
}
...
DESUL_INLINE_FUNCTION T device_atomic_fetch_and(T* const dest,
                                                ...
                                                MemoryOrder order,
                                                MemoryScope scope) {
  return device_atomic_fetch_oper(AndOper<T, const T>(), dest, val, order, scope);
}
...
DESUL_INLINE_FUNCTION T device_atomic_fetch_or(T* const dest,
                                               ...
                                               MemoryOrder order,
                                               MemoryScope scope) {
  return device_atomic_fetch_oper(OrOper<T, const T>(), dest, val, order, scope);
}
...
DESUL_INLINE_FUNCTION T device_atomic_fetch_xor(T* const dest,
                                                ...
                                                MemoryOrder order,
                                                MemoryScope scope) {
  return device_atomic_fetch_oper(XorOper<T, const T>(), dest, val, order, scope);
}
...
DESUL_INLINE_FUNCTION T device_atomic_fetch_nand(T* const dest,
                                                 ...
                                                 MemoryOrder order,
                                                 MemoryScope scope) {
  return device_atomic_fetch_oper(NandOper<T, const T>(), dest, val, order, scope);
}
...
DESUL_INLINE_FUNCTION T device_atomic_add_fetch(T* const dest,
                                                ...
                                                MemoryOrder order,
                                                MemoryScope scope) {
  return device_atomic_oper_fetch(AddOper<T, const T>(), dest, val, order, scope);
}
...
DESUL_INLINE_FUNCTION T device_atomic_sub_fetch(T* const dest,
                                                ...
                                                MemoryOrder order,
                                                MemoryScope scope) {
  return device_atomic_oper_fetch(SubOper<T, const T>(), dest, val, order, scope);
}
...
DESUL_INLINE_FUNCTION T device_atomic_max_fetch(T* const dest,
                                                ...
                                                MemoryOrder order,
                                                MemoryScope scope) {
  return device_atomic_oper_fetch(MaxOper<T, const T>(), dest, val, order, scope);
}
...
DESUL_INLINE_FUNCTION T device_atomic_min_fetch(T* const dest,
                                                ...
                                                MemoryOrder order,
                                                MemoryScope scope) {
  return device_atomic_oper_fetch(MinOper<T, const T>(), dest, val, order, scope);
}
...
DESUL_INLINE_FUNCTION T device_atomic_mul_fetch(T* const dest,
                                                ...
                                                MemoryOrder order,
                                                MemoryScope scope) {
  return device_atomic_oper_fetch(MulOper<T, const T>(), dest, val, order, scope);
}
...
DESUL_INLINE_FUNCTION T device_atomic_div_fetch(T* const dest,
                                                ...
                                                MemoryOrder order,
                                                MemoryScope scope) {
  return device_atomic_oper_fetch(DivOper<T, const T>(), dest, val, order, scope);
}
...
DESUL_INLINE_FUNCTION T device_atomic_mod_fetch(T* const dest,
                                                ...
                                                MemoryOrder order,
                                                MemoryScope scope) {
  return device_atomic_oper_fetch(ModOper<T, const T>(), dest, val, order, scope);
}
...
DESUL_INLINE_FUNCTION T device_atomic_and_fetch(T* const dest,
                                                ...
                                                MemoryOrder order,
                                                MemoryScope scope) {
  return device_atomic_oper_fetch(AndOper<T, const T>(), dest, val, order, scope);
}
...
DESUL_INLINE_FUNCTION T device_atomic_or_fetch(T* const dest,
                                               ...
                                               MemoryOrder order,
                                               MemoryScope scope) {
  return device_atomic_oper_fetch(OrOper<T, const T>(), dest, val, order, scope);
}
...
DESUL_INLINE_FUNCTION T device_atomic_xor_fetch(T* const dest,
                                                ...
                                                MemoryOrder order,
                                                MemoryScope scope) {
  return device_atomic_oper_fetch(XorOper<T, const T>(), dest, val, order, scope);
}
...
DESUL_INLINE_FUNCTION T device_atomic_nand_fetch(T* const dest,
                                                 ...
                                                 MemoryOrder order,
                                                 MemoryScope scope) {
  return device_atomic_oper_fetch(NandOper<T, const T>(), dest, val, order, scope);
}
...
DESUL_INLINE_FUNCTION void device_atomic_store(T* const dest,
                                               ...
                                               MemoryOrder order,
                                               MemoryScope scope) {
  (void)device_atomic_fetch_oper(StoreOper<T, const T>(), dest, val, order, scope);
}
...
DESUL_INLINE_FUNCTION T device_atomic_fetch_inc_mod(T* const dest,
  ...
  return device_atomic_fetch_oper(IncModOper<T, const T>(), dest, val, order, scope);
}
...
DESUL_INLINE_FUNCTION T device_atomic_fetch_dec_mod(T* const dest,
  ...
  return device_atomic_fetch_oper(DecModOper<T, const T>(), dest, val, order, scope);
}
